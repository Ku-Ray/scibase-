...
export const PAIR_SEO: Record<string, { title: string; description: string }> = {
  ...
  'pantothenic-acid-vs-niacinamide': {
    ...
    description: 'ナイアシンアミド（ビタミンB3・外用5%）とパントテン酸（ビタミンB5・パンテノール 1-5%）の違いを論文で比較。\n\nナイアシンアミドは表皮でメラニン輸送阻害・バリア機能強化・抗炎症の3方面に作用（Hakozaki 2002 RCT 5%×8週で色素沈着改善・Bissett 2005 で小じわ改善）、パントテン酸（D-パンテノール）はCoA前駆体として角質層の水分保持・上皮再生・修復シグナルに作用（Ebner 2002 D-パンテノール5%で皮膚バリア機能改善・Yang 2018 で創傷治癒促進報告）。\n\n作用ターゲットが表皮ケラチノサイトの代謝経路（B3）vs バリア・修復経路（B5）で異なる補完関係で、両者は併用が論文ベース。経口B5はニキビ高用量療法（10g/日 Lit-Hung Leung 1995 オープン試験）の議論がありますが、現代の論文では「経口B5は脂質代謝関連の弱いエビデンス・外用パンテノールの方が安定」と整理。有効濃度・効果が出るまで（ナイアシンアミド 4-8週・パンテノール 2-4週）、ニキビ・敏感肌・乾燥肌での使い分け、妊娠中の安全性、CICA製品（パンテノール+センテラ配合）との位置づけを化粧品メーカー視点で解説。',
  },
  'astaxanthin-vs-omega3': {
...
export const PAIR_CUSTOM_FAQS: Record<string, { q: string; a: string }[]> = {
  'glutathione-vs-niacinamide': [
    ...
    {
      q: 'グルタチオン点滴と経口で効果は違う？',
      a: '別物として扱う必要があります。\n\nグルタチオン点滴は医療機関で行う注射（血中濃度を一気に上げる）で、自己購入はできません。一方経口グルタチオンは消化管を経るため血中濃度上昇は穏やかで、効果も限定的です。点滴の効果を経口に外挿するのは論文ベースで誤りで、「点滴で白くなった人がいる」=「経口でも同じ効果」ではありません。経口で論文整合的に効果を狙うなら、ナイアシンアミド5%外用との併用がコスパ良い選択です。',
    },
    {
      q: '結局、コスパで選ぶならどっちから？',
  ...
  'arbutin-vs-azelaic-acid': [
    ...
    },
    {
      ...
      a: 'α-アルブチンは 2% が標準濃度で、これ以上の濃度は化粧品では一般的でなく、論文RCTも2%が中心です（Hamed 2020）。アゼライン酸は 10-15%が市販品の標準・20%は処方箋ベースで、軽度〜中度の色素沈着・ニキビ対策には10-15%で十分なエビデンスがあります（Searle 2020 メタ解析）。20%は皮膚科処方が必要なケースが多く、自己購入よりも医師相談が安全です。「濃度を上げれば早く効く」ではなく、継続できる刺激レベルで続けるのが論文ベースの正解です。',
    },
    {
  ...
  'l-citrulline-vs-creatine': [
    ...
    },
    {
      ...
      a: '初心者は クレアチン3〜5g/日 単独から始めるのが論文ベースの推奨です。クレアチンはエビデンス階層S（複数のメタ解析）・コスパ良・副作用ほぼなしで、長期的な筋力・体組成・認知機能への効果が確立しています。3〜4週間の継続で効果実感後、上級者として更にパフォーマンスを上げたい場合に シトルリン6〜8g（運動前30-60分）を追加 する順序が効率的です。即パンプ感を求める短期目的（試合・撮影前）であればシトルリン単独もアリです。',
    },
    {
  ...
  'nmn-vs-coq10': [
    ...
    },
    {
      ...
      a: '論文ベースの優先順位は年齢で変わります。\n\n30代前半まではCoQ10から始める方が合理的です：エビデンスが豊富（メタ解析多数）、月コスト¥1,000-3,000、心臓・運動・抗酸化への効果が確立。\n\n30代後半-40代以降は NAD+ が顕著に低下するため（Massudi 2012 で30代以降に組織NAD+の有意低下を報告）、CoQ10にNMNを追加する戦略が論文整合的です。NMN単独より、まず基盤としてCoQ10、必要に応じてNMN追加が現実的です。',
    },
    {
  ...
  'niacinamide-vs-collagen-peptide': [
    ...
    },
    {
      ...
      a: '「ペプチド」と一括りにすると論文ベースの判断を誤ります。\n\n経口コラーゲンペプチド（2.5〜10g/日）はProksch 2014 RCTで皮膚弾力28%改善（n=69・8週）と論文の厚みがあり、真皮の弾力アプローチでは現時点で最強です。\n\n外用シグナルペプチドはパルミトイルペンタペプチド-4（マトリキシル）・パルミトイルトリペプチド・銅ペプチド（GHK-Cu）・アセチルヘキサペプチド-8（Argireline）等の多様な分子群があり、コラーゲン産生シグナル経路（マトリキシル/銅ペプチド）と神経筋接合阻害経路（Argireline）に分かれます。エビデンス量で言えばナイアシンアミド > 経口コラーゲンペプチド > マトリキシル > 銅ペプチド > Argirelineの順で、ナイアシンアミドが論文の厚みで頭ひとつ抜けています。「迷ったらナイアシンアミド外用5%＋経口コラーゲンペプチド5g/日」が30代から始める論文整合的な第一選択で、外用シグナルペプチドはエビデンス階層B（emerging）として追加検討する位置付けです。',
    },
    {
    ...
    },
    {
      ...
      a: '「単独で効く」のエビデンスはどちらも報告されていますが、層の厚みではナイアシンアミド外用が一段上です。\n\nナイアシンアミド外用5%は Bissett 2005 RCT（n=50・8週）で色素沈着・小じわ・バリア機能の有意改善、複数の追試RCTでも再現性が確認されており、エビデンス階層S（独立した複数RCTで効果確立）。\n\n経口コラーゲンペプチドは Proksch 2014 RCT（n=69・8週）で皮膚弾力28%改善、Asserin 2015 RCTで真皮密度改善等が報告されており、エビデンス階層A（複数RCTあり）。両者とも独立成分として効果がRCTで報告されていますが、ナイアシンアミドの方が研究数・再現性で層が厚く「論文ベースで失敗しにくい」第一選択です。ただし作用層が表皮vs真皮で完全分離のため、片方だけでは取りこぼしが出ます。「どちらか片方しか始められないならナイアシンアミド外用、両方始められるなら併用」が論文整合的な判断です。',
    },
  ],
  'l-carnitine-vs-creatine': [
    {
    ...
    },
    {
      ...
      a: '「ダイエット」を「体脂肪を減らす」と定義するなら、エビデンスの方向性が異なります。\n\nL-カルニチンは Pooyandjoo 2016 メタ解析（9 RCT・n=911）で2,000mg/日 8〜24週で体重 -1.33kg・BMI -0.47kg/m²の有意減少が報告されており、脂肪酸燃焼の理論経路と整合的です。ただし「劇的に痩せる」サイズの効果ではなく、運動・食事改善と組み合わせて初めて意味が出るレベルです。\n\nクレアチンは除脂肪体重（筋肉量）を増やす方向の作用で、初期は体内水分量増加で1〜2kg体重が増えることがあります。「体重を減らす」目的にはマイナスに見えますが、基礎代謝向上の長期的な脂肪燃焼基盤としては有効です。「短期で体重を落とす」ならL-カルニチン＋有酸素運動、「中長期で代謝の高い体を作る」ならクレアチン＋筋トレ、というのが論文ベースの使い分けです。両者は併用OKで、ダイエット中の筋肉量維持にクレアチンを置く運用が現実的です。',
    },
    {
  ...
  'melatonin-vs-l-theanine': [
    ...
    },
    {
      ...
      a: '推奨順序：まずL-テアニン100〜200mgから試すのが論文整合的です。理由は、①日本国内で普通にサプリとして購入できる（メラトニンは医薬品扱いで個人輸入前提）、②副作用報告がほぼなく安全性が高い、③仕事終わりや就寝前のルーティンに組み込みやすい、の3点です。テアニン4〜8週間で「寝つきの不安・思考の止まらなさ」が改善しない場合に、メラトニン0.5〜1mgの追加を検討する流れが現実的です。「不眠が慢性化している」「明け方覚醒する」「概日リズム障害（時差ぼけ・交代勤務）」がある場合は、テアニンだけでは不十分でメラトニン側のアプローチが論文ベースで有効です。',
    },
    {
  ...
  'tranexamic-acid-vs-niacinamide': [
    ...
    },
    {
      ...
      a: '症状の重さで分けます。\n\n軽度〜中度の色素沈着・炎症後色素沈着であれば外用2〜5%（市販美白美容液・医薬部外品で配合あり）で4〜12週間試すのが第一選択です。\n\n両頬の対称的な肝斑・外用で改善しない頑固な色素沈着については経口250〜500mg/日が皮膚科で処方されることがあり、メタ解析でmMASI改善が報告されています。経口は血栓リスクがあるためピル（経口避妊薬）・抗凝固薬（ワルファリン等）併用中、血栓症の既往、妊娠中・授乳中は禁忌または医師相談必須です。「市販外用→4〜12週評価→不十分なら皮膚科で経口検討」が論文整合的なステップです。',
    },
    {
    ...
    {
      q: '効果が出るまでとコスパで結局どっち？',
      a: '初心者はナイアシンアミド外用5%単独から始めるのが論文整合的な順序です。エビデンスが豊富（Bissett 2005他複数RCT）、月コスト¥2,000〜5,000、刺激ほぼなしで朝晩OK、妊娠中も比較的安全という4拍子で参入障壁が低い成分です。8〜12週評価して色素沈着が頑固に残る場合にトラネキサム酸外用2〜5%を追加（朝ナイアシンアミド・夜トラネキサム酸の朝晩分離など）、それでも改善しない肝斑には皮膚科で経口トラネキサム酸250〜500mg/日を相談する3段階が論文ベースの王道です。「いきなり経口」ではなく「外用2成分の併用→経口検討」が安全とコスパの両面で合理的です。',
    },
  ],
  'pdrn-vs-hyaluronic-acid': [
    {
    ...
    },
    {
      ...
      a: '使用不可です。PDRNはサケ精巣由来のDNA断片を原料とするため、サケ・サーモン・魚介類にIgE型アレルギーがある方は外用でも避ける必要があります（製品の禁忌事項にも記載）。「DNA断片に精製されているからアレルゲンタンパクは残らない」という説明が一部でなされますが、精製度は製品により異なり、安全性が確立されていない以上、魚介アレルギー保有者には推奨されません。代替策として、コラーゲン産生促進を狙うならレチノール（Kafi 2007 RCTでシワ改善）、ナイアシンアミド（バリア・小じわ）、ペプチド系（Matrixyl/銅ペプチド等）が論文ベースの選択肢になります。',
    },
    {
      q: '効果が出るまでとコスパで選ぶならどっち？',
      a: '即時の保湿実感ならヒアルロン酸（外用直後〜数日で角層含水量が上がる体感がある）、中長期のシワ・ハリにはPDRN（12〜24週継続で評価）が論文整合的な分け方です。月コストはヒアルロン酸配合化粧品は幅広く¥1,000〜5,000、PDRN配合セラムは¥3,000〜8,000程度で、PDRNは新興成分のため割高傾向です。\n\nまずヒアルロン酸を基礎の保湿軸に据え、シワ・たるみへの追加対策としてPDRNセラムを夜のスペシャルケアに置く順序が現実的です。レチノール・ビタミンCと比較するとPDRNはエビデンス階層がB（新興・emerging）で、エビデンスの厚みで選ぶならレチノールを優先するのも論文整合的な判断です。',
    },
  ],
  'maca-vs-ashwagandha': [
    {
    ...
    {
      q: '結局、どちらから始めればいい？',
      a: 'エビデンスの厚みで言えばアシュワガンダ（KSM-66 300mg/日）から始めるのが論文ベースの推奨です。コルチゾール低下RCTが複数あり、ストレス耐性・睡眠の質・男性活力という汎用課題に幅広く対応する成分で、月コスト¥1,500〜3,500とコスパも良好です。8〜12週評価後に「更年期症状・性機能で物足りない」と感じる場合にマカ1,500〜3,500mg/日を追加する流れが効率的です。女性の更年期症状が主訴・かつアシュワガンダの上気・甲状腺刺激が気になる場合はマカ単独から始めるのも合理的です。両者とも継続性が最重要で、最低8週間は同条件で続けてから判定するのが論文整合的です。',
    },
  ],
  'retinol-vs-niacinamide': [
    {
    ...
    {
      q: '妊娠中・授乳中はどちらが使える？',
      a: 'レチノールは妊娠中NG・授乳中も慎重対応です。経口レチノイド（イソトレチノイン・経口レチノール大量摂取）で胎児への催奇形性リスクが確立されており、外用レチノールでも血中移行は限定的とはいえ国内外の皮膚科ガイドラインで妊娠中の使用は推奨されていません。\n\nナイアシンアミドは妊娠中・授乳中も比較的安全とされ、米国皮膚科学会のレビュー等で「妊娠中の使用に問題なし」と整理されています（ただし最終判断は産婦人科医に確認）。「妊娠中の美白・くすみケア」が主訴なら、レチノールを中断してナイアシンアミド5%＋ビタミンC外用＋日焼け止めの組み合わせに切り替えるのが論文整合的です。',
    },
    {
      q: 'レチノール初心者はどう始める？ナイアシンアミドとの並走順は？',
      a: 'まずナイアシンアミド5%で肌のバリア基盤を作ってからレチノールを低濃度で導入する順序が論文整合的です。具体的には、①ナイアシンアミド5%朝晩を4〜8週継続して肌の落ち着きを確認、②レチノール0.025〜0.1%を夜・週2回から開始（A1反応＝赤み/皮むけが起きやすい初期2〜4週は頻度を上げない）、③刺激がなければ週3〜5回に増やし、3〜6ヶ月かけて0.3〜0.5%に濃度を上げる、の3段階が王道です。レチノールはピーリング系（AHA/BHA・グリコール酸）・ビタミンC高濃度との同時塗布で刺激が増えるため、別の日や朝晩で分離するのが安全です。',
    },
    {
      q: '効果が出るまでと月コストの差は？',
  ...
  'ashwagandha-vs-rhodiola': [
    ...
    {
      q: '朝の集中・疲労感ならどっち？',
      a: 'ロディオラが論文ベースで先行します。SHR-5標準化エキスのRCT複数で「精神疲労・夜勤の認知低下・バーンアウト」への改善が報告されており、特に朝・午前中の摂取で覚醒感が出やすい特性があります。Phytomedicine 2010ではSHR-5 170mg/日×4週で夜間勤務医師の計算課題で誤り率改善、Journal of Sports Medicine 2017では200mg/日×12週でバーンアウト症候群の燃え尽き・うつ・疲労が改善と報告されました。アシュワガンダも疲労改善RCTはありますが、ロディオラほど「朝の覚醒・抗疲労」に特化しておらず、慢性疲労・ストレス疲弊が主訴ならロディオラ朝・アシュワガンダ夜の併用が論文整合的です。',
    },
    {
    ...
    {
      q: '初心者はどちらから始めるべき？',
      a: '主訴で分けるのが論文整合的です。\n\n①ストレス・不眠・回復が主訴 → アシュワガンダ KSM-66 300mg/日（夜の食後）。\n\n②精神疲労・集中力低下・バーンアウト傾向が主訴 → ロディオラ SHR-5 200mg/日（朝の空腹時または食前30分）。\n\n③両方の課題がある → 朝ロディオラ + 夜アシュワガンダの二段スタック、の使い分けです。両者とも8〜12週の継続評価が論文ベースで、短期で「効かない」と判断するのは早すぎます。月コスト¥1,500〜3,500（単独）・¥3,000〜5,000（併用）で、いずれも継続性が最重要です。',
    },
  ],
  'pdrn-vs-retinol': [
    {
    ...
    {
      q: '妊娠中・授乳中はどちらが使える？',
      a: 'レチノールは妊娠中NG・授乳中も慎重対応です。経口レチノイドの催奇形性リスクが確立されており、外用でも国内外の皮膚科ガイドラインで妊娠中の使用は推奨されていません。一方PDRNは妊娠中・授乳中の使用について明確な禁忌は確立されていない（サケ・魚介アレルギーは禁忌）ものの、妊娠中のスキンケア成分は基本的に「リスク回避＝控えめ」が安全側の判断です。妊娠中にコラーゲン産生を狙うなら、レチノール・PDRNいずれも積極使用せず、ナイアシンアミド5%＋ペプチド系＋ビタミンC外用の組み合わせが論文整合的に安全な代替路線です。最終判断は産婦人科医に確認してください。',
    },
    {
      q: 'PDRN外用は注射と同じ効果が期待できる？',
    ...
    {
      q: '結局、どちらから始めるべき？',
      a: 'エビデンスの厚みで選ぶならまずレチノール低濃度（0.025〜0.1%）から開始が論文ベースの王道です。複数のメタ解析・RCTで光老化・シワ・たるみへの有意な改善が確立されており、月コスト¥3,000〜8,000で参入もしやすい成分です。レチノールが刺激で続けられない・妊娠中・サケアレルギーがない敏感肌志向、という場合にPDRN 0.5〜1%セラムを代替路線として選ぶのが現実的です。30代以降で「シワ・たるみへのアグレッシブな対策」が主訴ならレチノール、「再生・修復・低刺激の韓国コスメ路線」が好みならPDRN、両方の経路でアプローチしたいなら朝PDRN・夜レチノールの併用が論文整合的です。',
    },
  ],
  'tranexamic-acid-vs-arbutin': [
    {
    ...
    },
    {
      ...
      a: '初心者はまず外用同士の併用（α-アルブチン2%＋トラネキサム酸外用2〜5%）から始めるのが論文整合的な順序です。外用は刺激リスクが低く、ピル・抗凝固薬・血栓既往との併用懸念もありません。4〜12週評価して頑固な肝斑・両頬対称の色素沈着が外用だけでは改善しない場合に、皮膚科で経口トラネキサム酸250〜500mg/日を相談する3段階が安全とコスパの両面で合理的です。経口は血栓リスクがあるため自己判断での開始は推奨されず、必ず皮膚科医・婦人科医に確認した上で判断してください。',
    },
    {
      q: '効果が出るまでとコスパで結局どっち？',
      a: 'α-アルブチン2%単独から開始するのがエビデンスの厚み・刺激リスク・コスパの3拍子で論文整合的です。月コスト¥2,000〜4,000、妊娠中も比較的安全、刺激ほぼなしで参入障壁が低い成分です。Hamed 2020 RCTでは2%×12週で色素沈着改善が報告されており、効果実感は8〜12週が目安です。8〜12週評価して頑固な肝斑が残る場合にトラネキサム酸外用2〜5%を追加（朝アルブチン・夜トラネキサム酸など）、それでも改善しない肝斑には経口トラネキサム酸を皮膚科で相談する3段階が王道です。「いきなり経口」や「ハイドロキノンに切り替え」ではなく、「外用2成分の併用→経口検討」が安全とコスパの両面で合理的です。',
    },
  ],
  'salicylic-acid-vs-glycolic-acid': [
    {
    ...
    },
    {
      ...
      a: 'サリチル酸はアスピリンアレルギー・妊娠中・授乳中NGです。サリチル酸はアスピリン（アセチルサリチル酸）と同系統の化合物で、アスピリンアレルギーの方は外用でも禁忌、妊娠中は外用でも血中移行のリスクから国内外の皮膚科ガイドラインで使用を控える方針が一般的です。\n\nグリコール酸は妊娠中の使用について明確な禁忌は確立されていないものの、刺激リスクと光感受性増加を踏まえ低濃度（5%以下）・低頻度（週1〜2回）の慎重使用が安全側の判断です。妊娠中に角質ケアを行うなら、両者を避けてラクトビオン酸・乳酸（マイルドなAHA）・酵素洗顔等の代替路線が論文整合的に安全です。最終判断は産婦人科医に確認してください。',
    },
  ],
  'niacinamide-vs-azelaic-acid': [
    {
    ...
    },
    {
      ...
      a: 'ナイアシンアミド5%が初心者向け・アゼライン酸15〜20%が頑固な肝斑向けの使い分けが論文整合的です。ナイアシンアミドは低刺激で参入障壁が低く、Bissett 2005 RCTでバリア機能・色素沈着・毛穴・小じわの4方面に効果が報告されているため、まず4〜8週試して肌の落ち着きを確認するのが王道です。8〜12週評価して頑固な肝斑が残る場合にアゼライン酸15〜20%を夜に追加（JDT 2020 RCTで20%×24週がハイドロキノン4%と同等の肝斑改善）するステップが論文整合的です。両者とも妊娠中も比較的安全な点でハイドロキノンの代替路線として有効です。',
    },
    {
      q: '効果が出るまでとコスパで結局どっち？',
      a: 'ナイアシンアミド5%単独から開始するのが論文整合的な順序です。月コスト¥2,000〜5,000で参入障壁が低く、4〜8週で色素沈着・毛穴・小じわ・バリア改善が体感しやすい4拍子の汎用成分です。アゼライン酸は15〜20%濃度で月コスト¥2,800〜5,000程度、効果実感まで12〜24週とやや時間がかかりますが、ニキビ・酒さ・肝斑への直接効果が強い点が魅力です。「初心者・汎用ケア」ならナイアシンアミド、「ニキビ＋色素沈着＋酒さの多機能ケア」ならアゼライン酸、「両方の課題」なら朝ナイアシンアミド・夜アゼライン酸の併用が論文ベースの王道です。妊娠中もどちらも比較的安全な点でハイドロキノンより使いやすい代替路線です。',
    },
  ],
  'acetyl-l-carnitine-vs-creatine': [
    {
  ...
  'vitamin-c-topical-vs-niacinamide': [
    ...
    {
      q: '朝と夜、どちらにどれを使う？',
      a: '推奨パターン：朝＝ビタミンC外用＋日焼け止め（抗酸化シールド・紫外線でできた活性酸素を中和）。\n\n夜＝ナイアシンアミド5%＋保湿クリーム（バリア修復・ターンオーバー時の色素沈着・毛穴ケア）の朝晩スタックが論文整合的です。理由は、①VCは抗酸化が主作用のため紫外線曝露前の朝に置くと光保護に直結、②Niaはバリア・色素沈着ケアが主作用のため肌の修復タイミングである夜が機能的、③刺激リスクを朝晩で分離できる、の3点です。同時併用したい場合はVC→数分待ってNia→保湿の順序が無難です。',
    },
    {
      q: '妊娠中・授乳中はどちらが使える？',
    ...
    {
      q: '結局、初心者はどちらから始めるべき？',
      a: 'ナイアシンアミド5%単独から開始するのが論文整合的な順序です。月コスト¥2,000〜5,000で参入障壁が低く、4〜8週で色素沈着・毛穴・小じわ・バリア改善が体感しやすい4拍子の汎用成分です。Bissett 2005のRCTで効果が確立しており、刺激ほぼなし・朝晩OK・妊娠中も比較的安全という3拍子で「失敗しない初手」として最適です。4〜8週評価して肌が落ち着いた段階でビタミンC外用（誘導体5〜10%→徐々にL-アスコルビン酸15%まで）を朝に追加するのが論文ベースの王道。「最初から両方併用」より「Niaで基盤を作ってからVCを足す」順序が刺激リスクと継続性の両面で合理的です。',
    },
  ],
  'hyaluronic-acid-vs-ceramide': [
    {
    ...
    },
    {
      ...
      a: '併用OK・むしろ論文ベースで強く推奨されます。「HAで吸い込み、セラミドで閉じ込める」の二段スタックが乾燥・小じわケアの王道で、市販でもHA＋セラミド同時配合の保湿クリームが普及しています。推奨順序：洗顔→化粧水（HA配合）→美容液→セラミドクリームで蓋をする、の流れが論文整合的です。理由は、①HAは水溶性で水分と一緒に角層に届きやすい、②セラミドは油溶性でバリア膜を形成して水分逃げを抑える、③この順序で吸水→保湿閉じ込めが完結する、の3点です。',
    },
    {
      q: '低分子ヒアルロン酸と高分子ヒアルロン酸、どっちを選ぶ？',
      a: '目的別の使い分け：①低分子HA（5万〜30万ダルトン）は浸透型で角層〜表皮深部に届き、ふっくら感・小じわケアに作用。\n\n②高分子HA（100万〜200万ダルトン）は表面保護型で角層上に膜を作り、即時の保湿感・水分蒸散抑制に作用。\n\n③加水分解HA（数千〜数万ダルトン）はさらに浸透型で深部保湿を狙います。多くの市販製品は2〜3種類を複合配合しており、「複数分子量HA配合」と表記された製品を選ぶと表層〜深部までカバーできます。低分子のみは表面保護が弱く、高分子のみは深部保湿が弱いため、複合配合が論文ベースで合理的です。',
    },
    {
      q: '敏感肌・アトピー素因なら、どっちを優先すべき？',
      a: 'セラミド優先が論文整合的です。アトピー性皮膚炎・敏感肌・乾燥性皮膚炎の患者ではセラミド（特にセラミド3・セラミド6Ⅱ・セラミドAP等）の細胞間脂質が減少していることがJID等で確認されており、セラミド補給で皮膚バリアが回復して刺激物・アレルゲン侵入を抑える経路が論文ベースで支持されています。HAも保湿として有効ですが、バリア機能そのものの修復作用はセラミドが優位です。具体的にはセラミド配合クリーム（CeraVe・キュレル・ノブⅢ等）を朝晩使用し、HA配合化粧水・美容液をその前のステップに置く順序が王道です。',
    },
    {
      q: '経口ヒアルロン酸と経口セラミドは効く？外用との違いは？',
      a: '両者とも経口エビデンスは外用より限定的ですが、論文蓄積は進んでいます。\n\n経口HA（120〜240mg/日）は腸管で分解されて低分子断片として吸収されるルートが報告されており、JNH 2017 RCT n=60で食物由来HA120mg/日×12週で皮膚水分量改善が示されています。\n\n経口セラミド（米由来グルコシルセラミド40〜80mg/日）はJDS 2017 RCT n=63で角層水分量・TEWL改善が報告されており、外用と経口の併用で相乗効果を狙う設計が機能性表示食品でも普及しています。ただし外用直接アプローチほどの即時効果は期待できず、「外用が主・経口は補助」の位置づけが論文整合的です。',
    },
  ],
  'arbutin-vs-kojic-acid': [
    {
    ...
    {
      q: '結局、どっちを選べばいい？',
      a: '初心者・長期継続志向ならα-アルブチン2%が論文整合的な第一選択です。月コスト¥2,000〜4,000、刺激ほぼなし、妊娠中も比較的安全、Hamed 2020 RCTでエビデンス確立という4拍子で参入障壁が最も低い成分です。8〜12週評価して頑固な肝斑が残る場合にコウジ酸1〜2%を追加検討、またはアゼライン酸15〜20%・トラネキサム酸外用2〜5%・ハイドロキノン外用（皮膚科処方）といった経路の異なる成分への乗り換えが論文ベースの王道です。「いきなりコウジ酸高用量」より「アルブチンで基盤→必要なら他経路追加」の順序が安全とコスパの両面で合理的です。',
    },
  ],
  'ashwagandha-vs-l-theanine': [
    {
    ...
    },
    {
      ...
      a: '急性ストレス（仕事中の緊張・面接前・プレゼン前・試験前）はL-テアニン200mgが論文ベースの第一選択です。経口摂取後30〜60分でα波増加・コルチゾール低下が始まり、当日のパフォーマンスに直結します。眠気を起こさず冷静さを保つため、運転前・仕事中でも使いやすい安全プロファイルです。\n\n慢性ストレス（睡眠の質低下・コルチゾール過剰・男性活力低下・燃え尽き感）はアシュワガンダKSM-66 300〜600mg/日が論文ベースの第一選択です。8〜12週の継続でコルチゾール低下・睡眠の質スコア改善が報告されており、累積効果でストレス耐性そのものを引き上げる位置付けです。両方ある場合は併用が論文整合的です。',
    },
    {
      q: 'アシュワガンダの併用注意は？どんな人は飲めない？',
      a: '禁忌・併用注意が多い成分です。①妊娠中・授乳中NG（流産誘発の動物試験報告）、②自己免疫疾患（橋本病・関節リウマチ・多発性硬化症等）でTh1免疫を活性化する可能性、③SSRI・SNRI等の抗うつ薬で相加作用、④甲状腺薬（レボチロキシン）で甲状腺ホルモン上昇の報告、⑤降圧薬・血糖降下薬で過降下リスク、⑥肝疾患既往（稀に肝障害報告）、⑦ホルモン依存性疾患（前立腺がん・乳がん等）、が主な禁忌・併用注意項目です。テアニンは緑茶由来で禁忌・併用注意がほぼなく安全性が高い対照的なプロファイル。複数の併用注意が重なる方はテアニン単独から始めるのが論文ベースで安全です。',
    },
    {
      q: '初心者はどちらから始めるべき？月コストは？',
      a: '初心者はL-テアニン100〜200mg/日から始めるのが論文整合的な順序です。理由は、①即時効果が体感しやすく続けやすい、②禁忌・併用注意がほぼなく安全プロファイル最強、③緑茶由来で食品成分として国内サプリ普及済み、④月コスト¥1,000〜2,500と低コスト、の4拍子です。4〜8週試して「慢性ストレス・睡眠の質低下・コルチゾール過剰の体感」が残る場合にアシュワガンダ KSM-66 300mg/日を夜の食後に追加（月¥1,500〜3,500）するのが論文ベースの王道。両方併用でも月¥2,500〜6,000で収まり、急性＋慢性の二軸ストレス対策が完成します。アシュワガンダは8〜12週評価が必須で、短期で「効かない」と判断するのは早すぎます。',
    },
  ],
  'ferulic-acid-vs-vitamin-c-topical': [
    {
      q: 'フェルラ酸とビタミンC外用の違いは？',
      a: '両者の関係は「対立」ではなく「シナジー」です。\n\nフェルラ酸（外用0.5〜1%）は米ぬか・小麦ふすま由来の植物性ポリフェノールで、単独でも紫外線吸収・抗酸化作用を持ちますが、論文蓄積の中心はビタミンCとビタミンEの安定化と効果倍増という補助役としての役割です。\n\nビタミンC外用（L-アスコルビン酸10〜20%・誘導体5〜15%）は抗酸化＋コラーゲン合成促進＋メラニン産生抑制の多経路で光老化対策の主役成分です。「主役のVC」と「VCを強化する脇役のフェルラ酸」と覚えると整理しやすく、フェルラ酸単独より「VC＋VE＋フェルラ酸」の三者スタックが論文ベースで合理的です。',
    },
    {
    ...
    {
      q: 'フェルラ酸単独で効果はある？',
      a: '単独効果のヒトRCTは限定的です。フェルラ酸は単独でも紫外線吸収（UVB領域）と抗酸化作用が in vitro で確認されていますが、外用ヒト試験のほとんどはVC・VEとの三者スタック評価で、単独使用の有効性については論文の厚みが薄いのが現状です。市販でも「フェルラ酸単独セラム」より「VC＋VE＋フェルラ酸」配合の抗酸化セラムが主流で、論文ベースでも単独使用は推奨されていません。「VCを使うならフェルラ酸を併用する」が論文整合的な結論です。',
    },
    {
      q: 'SkinCeuticals以外の選択肢は？コスパで比較すると？',
      a: 'SkinCeuticals C E Ferulic（30ml ¥21,000〜25,000）は高価帯のため、近年は同等処方の低価格代替品が普及しています。代表的な選択肢：①Maelove Glow Maker（米国・30ml ¥3,000〜4,000・VC15%＋VE1%＋フェルラ酸0.5%のSkinCeuticals処方クローン）、②Timeless Vitamin C+E Ferulic Acid Serum（米国・30ml ¥2,500〜3,500・iHerb等で取扱）、③国内ではロート製薬メラノCC・キールズパワフル-ストレングス-ライン-リデューシング・コンセントレート等のVC＋誘導体製品が低コスト。「処方そのものは公開技術」のため、安価な代替で十分に論文整合的な抗酸化シールドが構築できます。',
    },
    {
      q: 'フェルラ酸スタックの使い方とタイミングは？',
      a: '朝の最初のアクティブ成分として塗布→日焼け止めの順序が論文整合的です。洗顔→化粧水（保湿）→VC＋VE＋フェルラ酸セラム3〜4滴を顔全体に押し込む→保湿クリーム→日焼け止め（SPF30以上・PA+++以上）の流れで、紫外線曝露前に抗酸化シールドを構築します。低pH（2.5〜3.5）のL-アスコルビン酸処方は刺激が出やすいため、敏感肌は朝晩→朝のみ→週3〜5回と頻度を下げて慣らしてください。レチノール・AHA/BHAとの同時使用は刺激蓄積で続けにくいため、朝VCスタック・夜レチノール（またはAHA/BHA）の朝晩分離が安全です。月コスト¥3,000〜8,000（SkinCeuticals以外）で抗酸化シールドが完成します。',
    },
  ],
  // ── Sprint 1 Session A Day 2 バッチ 2026-05-12 ────────────────
  'vitamin-c-oral-vs-vitamin-c-topical': [
  ...
  'nmn-vs-nicotinamide-riboside': [
    ...
    },
    {
      ...
      a: '論文ベースのコスパ優位はNR（Tru Niagen 300mg/日 月¥3,500前後）が圧倒的です。Conze 2019 Sci Rep RCT n=140 8週で血中NAD+用量依存的上昇が確認され、長期安全性試験データもChromaDex社が蓄積中。NMNは¥6,000-12,000/月とコストが2-4倍高く、ヒトRCTは2020年以降の集中蓄積で歴史が浅めです。\n\n「論文の厚み × 月コスト」で見るとまずNRから8-12週試し、効果指標（血中NAD+検査・主観疲労）で判断、不満があれば舌下NMNを追加検討する順序が論文整合的です。「ChromaDex特許の独占構造を避けたい」「最新の研究を追いたい」ならNMNから始める選択も合理的で、両者とも血中NAD+上昇は確認されています。',
    },
    {
      q: 'NMNとNRは併用できる？効果は加算される？',
      a: '理論上は併用可能で安全性も高いですが、加算効果は限定的という現状評価です。両者とも最終的にNAD+に変換される経路を共有するため、片方を上限まで摂取した後にもう片方を追加しても血中NAD+の追加上昇は頭打ちになる可能性が高いです。Damgaard 2023 systematic reviewでも「NMN/NR両者ともNAD+前駆体として有効・両者の臨床アウトカム差は限定的」と評価されています。\n\n現実的には片方を選んで8-12週評価が論文ベースで合理的で、両方併用しても副作用は増えませんがコストは¥10,000/月超になりやすく、その予算は他のサプリ（CoQ10・オメガ3・マグネシウム）に分散する方が論文整合的です。',
    },
    {
      q: 'NMN・NRは何歳から始めるべき？効果指標は？',
      a: '推奨開始年齢は30代後半-40代以降が論文ベースの目安です。Massudi 2012 PLoS One で組織NAD+は20代で最高値、30代から低下開始、50代で20代の半分前後まで下がる縦断研究が報告されています。効果指標は①血中NAD+測定（NR 8-12週で用量依存的上昇）、②主観的疲労・睡眠の質（個人差大）、③臨床アウトカム（インスリン感受性・血圧・歩行速度等のヒトRCTで報告された指標は限定的）。「老けて見えなくなる」「寿命が延びる」等の体感的・長期的効果は現状のヒトRCTでは確立しておらず、Damgaard 2023 systematic reviewが「臨床アウトカム有意差は限定的」と慎重評価。\n\n8-12週で血中NAD+も主観効果も変化ゼロなら撤退判断も合理的です。',
    },
    {
  ...
  'creatine-vs-hmb': [
    ...
    },
    {
      ...
      a: '健常若年トレーニーはクレアチンモノハイドレート3-5g/日の一択が論文ベースの結論です。Phillips 2017 Nutrients レビュー、Jakubowski 2019 Med Sci Sports Exerc 等で「トレーニング刺激と栄養充足下で健常若年へのHMB追加効果はほぼ検出されない」と複数指摘されており、月¥3,000-5,000のコストを払う合理性は低いです。クレアチンは月¥1,500-2,500でエビデンスS、HMBは月¥3,000-5,000でエビデンスは集団限定。\n\n判断基準：①健常若年・筋トレ中級者→クレアチンだけ、②60代以上の筋量維持→クレアチン+HMB併用検討、③術後・寝たきり明け・絶食状況→HMB単独で筋分解抑制目的、④プロ競技者の追い込み期だけはHMB追加検討の余地ありが現実解です。',
    },
    {
      q: 'HMBは高齢者や初心者には効くって本当？論文ベースで対象は？',
      a: '高齢者・絶対的初心者・カタボリック状況では論文上効果が確認されています。\n\nWu 2015 Arch Gerontol Geriatr メタ解析では65歳以上の高齢者へのHMB 3g/日×12週で除脂肪体重・筋力・身体機能の有意改善が報告され、Wilson 2014 J Strength Cond Res でも初心者・カタボリック状況（術後・絶食・寝たきり）でHMBの抗異化作用エビデンスが集中しています。\n\nつまり「筋分解が亢進している集団」でこそHMBの真価が出る設計で、健常若年のように筋合成が回っている状態では追加効果が検出されにくい構造です。60代以上のサルコペニア対策、長期入院明け、激しい減量期のトレーニーには検討価値あり。クレアチンと併用しても薬理的に干渉せず、両者とも腎機能への実害は健常者では報告ないため60代以上の併用は論文整合的です。',
    },
    {
    ...
    },
    {
      ...
      a: '健常若年・中年トレーニーはクレアチンモノハイドレート一択、60代以上の筋量維持ならクレアチン+HMB併用が論文整合的な月支出です。月¥1,500-2,500のクレアチンモノハイドレート（Optimum Nutrition Creapure®/NOW Sports Creatine Monohydrate等のCreapure®特許品が品質安定）に対し、HMBは月¥3,000-5,000で適用集団が限定的。\n\n筋肉系サプリ予算ヒエラルキー：①第一優先=クレアチン（健常若年〜中年）、②第二優先=ホエイプロテイン（食事タンパク質不足時）、③第三優先=L-シトルリン6-8g/日（運動前のパンプ・乳酸クリアランス）、④第四優先=ベータアラニン3-5g/日（高強度持久力・乳酸緩衝）、⑤HMBは特定集団のみ追加検討です。「最新の流行サプリ」より論文蓄積の厚みと自分の集団適合性で選ぶのが論文ベースのコスパ最適化です。',
    },
  ],
  'melatonin-vs-glycine': [
    {
      q: 'メラトニンとグリシンの違いは？どっちが日本で買える？',
      a: '作用経路と国内入手可否が決定的に違います。メラトニンは脳の松果体由来の睡眠ホルモン補充で生体時計のリセット・概日リズム障害に作用、グリシンは天然アミノ酸として末梢血管拡張による深部体温低下経由の入眠改善に作用します。\n\n国内入手可否：日本ではメラトニンは医薬品扱い（睡眠導入剤類縁）でサプリ流通なし・個人輸入のみが選択肢で本サイトは推奨する立場ではなく事実として規制差を提示します。一方グリシンは食品扱いで味の素「グリナ」・iHerb・Amazonで誰でも購入可能（月¥1,000-4,000）。「軽い不眠でまず試したい」「自然な眠気を補助したい」ならグリシンが第一選択、「時差ぼけ・交代勤務・概日リズム障害」はメラトニンが論文整合的な使い分けです。',
    },
    {
  ...
  'ashwagandha-vs-panax-ginseng': [
    ...
    },
    {
      ...
      a: '【アシュワガンダ】KSM-66標準化抽出 300-600mg/日・朝食後が論文ベースの目安（Salve 2019・Chandrasekhar 2012 RCT）。Sensoril、CHO-A等の他規格化品も流通。【Panax人参】高麗紅参（Korean Red Ginseng）またはginsenoside標準化抽出 200-400mg/日が論文ベース（Reay 2010・Bach 2016 RCT）。市販品では正官庄（Cheong Kwan Jang・韓国KGC社）が世界最大シェアでginsenoside含有量明示。\n\n「ginsenoside量」がそのまま品質を表すため安価な人参茶等は規格化標準量を満たさない可能性があります。両者とも食事直後の脂質吸収併用が推奨で、空腹時は胃腸刺激あり。',
    },
    {
    ...
    },
    {
      ...
      a: '併用可能で、両者の経路独立を活かした補完設計が論文整合的です。【設計例】朝（高麗人参200mg）→集中力・末梢血流向上、夜（KSM-66 300-600mg 夕食後）→コルチゾール調整・睡眠の質向上の二段スタック。ただし過剰摂取・複数アダプトゲン同時開始は禁忌で、2-4週ずつ単独試行→効果と副作用評価→併用判断が安全側。【併用時の注意】①血糖降下：両者とも軽度血糖低下作用ありで糖尿病薬併用は要医師相談、②血圧低下：高用量併用で起立性低血圧の報告あり、③SSRI・抗うつ薬：理論的セロトニン症候群懸念で併用は医師相談、④ロディオラとの3者併用は経験的に過剰刺激（不眠・動悸）報告があり推奨されません。',
    },
    {
      q: '副作用・禁忌・薬物相互作用は？',
  ...
  'spermidine-vs-resveratrol': [
    {
      ...
      a: '作用経路が完全に独立しているため競合関係ではなく補完関係です。【スペルミジン】細胞内ポリアミンでautophagy（オートファジー・細胞内自食作用）誘導経由（Eisenberg 2009 Nat Cell Biolで酵母/線虫/マウス寿命延長・Madeo 2018 Nat Med 観察研究 n=829で食事性スペルミジン摂取量と心血管死亡率の逆相関）。【レスベラトロール】SIRT1活性化・カロリー制限模倣経由（Howitz 2003 Nature 古典論文・酵母/線虫/ハエ寿命延長）。\n\nautophagy（細胞内のリサイクル）とSIRT1（カロリー制限模倣）は longevity 文脈で並立する2大経路で、両者は重ならず併用設計が論文整合的です。',
    },
    {
      q: 'スペルミジンは食事から取れる？サプリ必要？',
      a: '食事改善が第一選択で、サプリは補助レイヤーが論文整合的です。【食事由来】小麦胚芽（約30mg/100g）・大豆発酵食品（納豆・味噌）・チーズ熟成品（パルメザン・ブルーチーズ）・干しシイタケが豊富。日本食は世界的にスペルミジン摂取量が多い食文化です。【Madeo 2018の評価軸】食事性スペルミジン摂取量を評価軸としており、精製サプリ単独のヒトRCTエビデンスはまだ初期段階。【サプリ】spermidineLIFE®（Longevity Labs社・小麦胚芽抽出標準化）等で1-3mg/日が論文ベース、月¥3,500-7,000の高価帯。【判断基準】「食事改善が難しい・小麦胚芽/納豆を日常的に取れない」場合の補助としてサプリを位置づけ、食事改善優先が費用対効果として現実的です。',
    },
    {
      q: 'レスベラトロールの寿命延長エビデンスは？',
      a: 'マウス〜小規模ヒト初期段階で、ヒトでの寿命延長は未確立というのが論文整合的な評価です。【マウス】Baur 2006 Natureで高脂肪食マウスのlifespan延長・代謝改善が報告。【ヒト】Tomé-Carneiro 2013 Pharmacol Res メタ解析で心血管リスクマーカー改善は確認・寿命延長エビデンスは未確立。\n\n「ヒトでX年寿命が延びる」断定的訴求はNGで、「動物実験で寿命延長が確認された」「ヒトで心血管リスクマーカー改善が報告された」型が論文整合的です。【Sinclair陣営の運用】David Sinclair教授（Harvard）はNMN+レスベラトロール+メトホルミンの個人運用を公表していますが、これは研究者個人の運用で、大規模ヒトRCTでの寿命延長エビデンスとは別レイヤーの話です。',
    },
    {
  ...
  'l-theanine-vs-gaba': [
    ...
    },
    {
      ...
      a: '【L-テアニン】200-400mg/日が論文ベース。Hidese 2019で200mg/日×4週で睡眠の質改善。\n\n急性効果は30-60分でα波増加・主観的リラックス感（Kobayashi 1998・Lu 2004 fMRI）、累積効果は2-4週で睡眠の質・心理ストレス症状改善。【GABA】PharmaGABA® 100-200mg/日が市販品の標準用量。Abdou 2006の急性効果も30-60分で報告されますがプラセボ差が穏やか。【判断基準】第一選択はテアニン200mgが論文整合的。「飲んで30分でリラックス」の即時感覚はテアニンの方が再現性高く報告されており、GABAは個人差が大きい印象が論文と一致します。GABAは「PharmaGABA®特定形態の補助レイヤー」として位置づけ、テアニンで効果不十分なら追加検討が現実的な順序です。',
    },
    {
      q: 'L-テアニンとGABAは併用できる？',
  ...
  'creatine-vs-l-glutamine': [
    ...
    {
      q: '筋トレ目的でどっち？',
      a: 'クレアチン圧勝で、健常若年トレーニーへの筋トレ目的ならグルタミンは期待外れです。【クレアチン】筋トレ補助エビデンスS（最強評価）・3-5g/日・¥1,000-2,500/月・コスパ最強。【グルタミン】健常若年トレーニーへの筋肥大/筋力効果はCandow 2001 等で否定的で、健常者では血中グルタミン濃度が枯渇しにくく、追加摂取の必要性が薄い。【判断基準】筋トレ目的でサプリ予算が限られるならクレアチン一択で、グルタミンに月¥1,500-3,500を回すならホエイプロテイン・クレアチン増量・ビタミンDの方が論文ベースのROIが高い。\n\n「筋トレ補助でグルタミンを買う」は2010年代までの古い常識で、現在の論文整合的な選択はクレアチン+ホエイ+ビタミンD+EAA（必須アミノ酸）の組み合わせです。',
    },
    {
  ...
  'ginkgo-biloba-vs-bacopa-monnieri': [
    ...
    },
    {
      ...
      a: '「認知症予防エビデンスは大規模RCTで否定的の誠実評価」が現代の論文整合的整理です。\n\nSnitz 2009 GEM trial JAMA n=3,069 健常高齢者にEGb 761® 240mg/日×中央値6年で認知症発症率の有意差なし、DeKosky 2008 JAMA でも認知症進行抑制エビデンス否定的でした。\n\nLe Bars 1997 JAMA RCT n=309 AD/血管性認知症患者でMMSE維持の古典論文はあるものの、その後の大規模RCTで予防効果は確認されておらず、市販品の「認知症予防」訴求は論文ベースで成立しません。現代の整理は「軽度の脳血流改善・末梢循環補助の補助的位置づけ」が誠実評価で、「認知症が治る」絶対NG→「軽度認知障害患者の一部RCTで認知機能スコア改善が報告された」型統一が論文整合的です。',
    },
    {
  ...
  '5-htp-vs-l-tryptophan': [
    ...
    },
    {
      ...
      a: '1989年Eosinophilia-Myalgia Syndrome（EMS・好酸球増多筋痛症候群）事件は、Showa Denko社製L-トリプトファン汚染ロット（製造プロセス変更で副産物EBT等が混入）が原因で米国で37名死亡・1,500名以上が筋痛・好酸球増多・神経障害の後遺症を発症した事件です（Slutsker 1990 JAMA・Belongia 1990 NEJM）。FDAは1989年にL-トリプトファン輸入規制を実施、2001年に部分緩和したものの注意喚起は継続しています。\n\n「現行のL-トリプトファンサプリは1990年代以降の製造プロセス改善で大規模事故は発生していない」ものの、歴史的経緯を踏まえた慎重論は今も妥当です。5-HTPはGriffonia種子由来で経路が異なるためEMS関連の汚染リスクは限定的ですが、Michelson 1994 Mayo Clin Proc で5-HTPでも好酸球増多症例の報告（Peak X様代謝物検出）があり、サプリ選択時は信頼できる第三者検査済みブランド（Now Foods/Thorne/Source Naturals）を選ぶのが論文整合的です。',
    },
    {
  ...
  'retinol-vs-bakuchiol': [
    ...
    },
    {
      ...
      a: 'レチノール（経口・外用とも妊娠中NG）＝催奇形性リスクで妊娠中・授乳中は使用回避（FDA Category Cレチノイド類縁・経口イソトレチノインは妊娠分類X）。\n\nバクチオールは「比較的安全」だが大規模ヒト試験は限定的の誠実評価が必要です。\n\nバクチオールの妊娠中安全性データ＝Babchi種子は伝統的アーユルヴェーダで皮膚疾患に外用使用されてきた歴史があり、Chaudhuri 2014・Dhaliwal 2019 等のRCTでも明らかな副作用は報告されていません。\n\nただし「妊娠中OK」と100%断定する大規模試験は未整備で、本サイトでは「妊娠中・授乳中は外用バクチオールも産婦人科医に確認の上で使用」を推奨します。\n\nレチノールの代替で妊娠中も使えるエビデンス確立成分＝①ナイアシンアミド5%外用（Bissett 2005 RCT 色素沈着・小じわ改善）、②ビタミンC（L-アスコルビン酸）15%外用、③ペプチド系（パルミトイルトリペプチド・Matrixyl 3000）の3軸が論文整合的に妊娠中安全と評価されています。',
    },
    {
      q: 'バクチオールはレチノールより本当に刺激が少ない？効果は同等？',
      a: '【刺激・赤み・乾燥の差】Dhaliwal 2019 RCT n=44で被験者報告されたスケーリング・乾燥はレチノール0.5%群で有意に多く、バクチオール0.5%群では少なかった結果が報告されています。【効果の同等性】同RCTで12週時点のしわ・色素沈着・写真評価では両者ほぼ同等ですが、①ヒトRCTの累積本数はレチノールが圧倒的（数百本 vs 数本）、②深いシワ・光老化への高濃度効果はトレチノイン処方薬（0.025-0.1%）が確立しており（Kligman 1986古典・Kafi 2007 Arch Dermatol）バクチオール単独では届かない領域、③バクチオールは朝晩使用可（レチノールは原則夜のみ・光分解）・日焼け止め必須要件が緩い・敏感肌で耐容性高い運用上の優位点があります。\n\n「同等」は0.5%濃度・12週・健常者という条件下での話で、深いシワ・光老化対策には引き続きレチノール（または処方トレチノイン）が主軸として論文整合的です。',
    },
    {
      q: '初心者・敏感肌はどっちから始めるべき？',
      a: '【判断フローチャート】①妊娠中・授乳中・妊娠予定→バクチオール第一選択（産婦人科医確認の上）、またはナイアシンアミド5%・VC15%外用に切替（妊娠中安全性データ厚い）、②敏感肌・赤み出やすい肌・酒さ既往→バクチオール0.5-2%朝晩から開始・刺激なければ4-8週で評価、③初心者・レチノール未経験→バクチオール0.5%で耐容性確認後にレチノール0.025-0.1%（低濃度）週2-3回夜から段階的導入、④深いシワ・光老化対策・中上級者→レチノール0.3-0.5%夜+バクチオール0.5%朝の朝晩スタックが論文整合的、⑤痤瘡（ニキビ）あり→処方アダパレン/トレチノインが第一選択でバクチオールは補助、で進めます。\n\nバクチオール導入の落とし穴＝SNSで「即効でしわが消える」訴求があるが12週以上の継続が論文整合的タイムライン、即効性訴求は誇大の可能性。月コスト¥3,500-9,000、市販品はOle Henriksen Goodnight Glow・The INKEY List Bakuchiol・Herbivore Bakuchiol Serum・The Ordinary系のSqualane配合品が選びやすい価格帯です。',
    },
    {
  ...
  'spermidine-vs-fisetin': [
    {
      ...
      a: '作用経路と投与設計が完全に独立しています。\n\nスペルミジンはポリアミンの一種でオートファジー（細胞内自食作用）誘導経路で蛋白質凝集物・損傷ミトコンドリアのクリアランスに作用し（Eisenberg 2009 Nat Cell Biol 酵母・線虫・マウス寿命延長）。\n\nMadeo 2018 Nat Med n=829 観察研究で食事性スペルミジン摂取量と心血管死亡率・全死亡率の逆相関が報告されています。\n\nフィセチンはフラボノール骨格でsenolytics（老化細胞除去）独立軸で作用し。\n\nYousefzadeh 2018 EBioMedicine マウスでlifespan延長が報告された新興成分です。投与設計が決定的に異なり。\n\nスペルミジンは毎日継続摂取（食事性摂取軸）／フィセチンは hit-and-run サイクル投与（2-3日連続→2-4週休薬）が David Sinclair等の研究者提唱パターンで真逆の投与設計です。両者は経路独立で併用可能ですが、寿命延長エビデンスはヒトで両者とも未確立である点を伝えるのが論文ベースで責任ある立場です。',
    },
    {
      q: 'スペルミジンは食事とサプリどちらが効率的ですか？',
      a: '食事改善が論文整合的にROI最高です。Madeo 2018 Nat Med n=829 観察研究は食事性スペルミジン摂取量評価軸で精製サプリ単独のヒトRCTエビデンスは初期段階に留まっています。\n\nスペルミジン豊富食品＝小麦胚芽（30mg/100g・最豊富）・大豆発酵食品（納豆・味噌）・チーズ熟成品・干しシイタケで日本食はもともと摂取量多い食文化です。\n\n小麦胚芽15g/日で4.5mg・納豆1パック2-3mg・熟成チーズ1スライス1-2mg程度で、食事だけで論文整合的範囲（1-5mg/日）に到達可能です。一方 spermidineLIFE®等の精製サプリは¥3,500-7,000/月かかり、同価格帯で食材改善＋ケルセチン（抗ヒスタミン二刀流・花粉症エビデンス確立 Mlcek 2016 Molecules）への投資の方が日常体感型のROIが見える領域です。\n\nサプリの優位性は摂取量が安定する点ですが、食事性摂取軸のエビデンスが主軸である現状を踏まえると。\n\nまず食事改善→不足分をサプリで補完が論文整合的順序です。',
    },
    {
  ...
  'lions-mane-vs-alpha-gpc': [
    ...
    {
      q: '効果が出るまでどのくらい？評価のタイミングは？',
      a: '【ライオンズマネ】16週で評価が論文用量（Mori 2009 16週RCTで有意差）、ただし4週で主観的集中力・物忘れ頻度の変化を記録開始が現実的設計です。短期で「頭がスッキリする」体感型のサプリではなく累積効果型（NGF誘導でゆっくり神経機能改善）という前提で12-16週継続評価が論文ベースの順序です。【α-GPC】運動パフォーマンス目的なら7日-2週で評価可能（Parker 2011 7日RCT・Marcus 2017 短期RCT）。\n\n認知機能目的なら3-6ヶ月評価（De Jesus Moreno 2003 6ヶ月RCT）で用途別に評価サイクル異なります。【両者併用】12-16週評価+認知機能の主観的変化記録（仕事のミス回数・名前度忘れ頻度・読書理解力・集中持続時間）が論文整合的フィードバック設計、改善なければ用量見直し（α-GPC 300→600mg/ライオンズマネ1→3g）か原因軸再評価（睡眠の質/慢性ストレス/甲状腺機能/うつ/MCI診断・YMYL領域は医療機関）が次のステップです。',
    },
  ],
  'zinc-vs-vitamin-c-oral': [
    {
      q: '亜鉛とビタミンCはどちらが風邪対策に効く？',
      a: 'タイミングと形態で使い分けが決定的です。\n\n風邪初期（症状出現24時間以内）→亜鉛グルコン酸/酢酸塩トローチ75-150mg/日が論文ベースで第一選択＝Hemilä 2013 Cochrane Database SR 13 RCT n=1,360で風邪期間14-28%短縮（イオン化亜鉛が鼻粘膜ICAM-1受容体ブロックでライノウイルス結合阻害機序）。\n\n経口カプセル形態は粘膜接触なく効果限定で形態がトローチ（口腔内溶解）であることが必須、クエン酸塩・乳酸塩は唾液pHで効果減弱のためグルコン酸/酢酸塩を選択します。\n\nビタミンC継続摂取はHemilä 2017 Cochrane Database 29 RCT大規模解析で一般人口での風邪罹患率低下なし・発症期間8%軽度短縮のみで予防効果は限定的。\n\n極端な身体的ストレス下（マラソンランナー・スキー部隊・寒冷地兵士）では風邪罹患率半減のサブグループ恩恵のみが論文整合的事実です。\n\nPauling博士の高用量ビタミンC仮説（1970年代）は後続大規模RCTで効果限定確認の科学史的経緯を踏まえた誠実評価が論文ベースの責任ある立場で、健常人の風邪予防目的でのビタミンC高用量継続は効果限定です。',
    },
    {
      q: '亜鉛の長期摂取で銅欠乏になるって本当？',
      a: '亜鉛長期高用量50mg/日以上で銅欠乏症リスクが上がることは論文ベースで確立されています（Sandstead 1995 Am J Clin Nutr 銅と亜鉛の腸管吸収競合機序）。\n\n銅欠乏は貧血・神経症状（末梢神経障害・運動失調）・心血管リスク（不整脈）で深刻な状態に至るため。\n\n長期サプリ補給時は亜鉛:銅比 10:1-15:1維持（亜鉛15-30mg/日なら銅1-2mg/日併用）が論文整合的設計です。\n\nDoctor\'s Best Zinc Glycinate Chelate + 銅併用品やBalanced Zinc/Copper複合サプリが市販されています。\n\n短期風邪対策のトローチ75-150mg/日（5-7日のみ）は銅欠乏リスク低い（短期間のため累積影響限定的）ため日常サプリ補給と短期トローチ使用は分けて考えます。\n\n血液検査での評価＝亜鉛は血清亜鉛（参考値80-130 μg/dL）、銅はセルロプラスミン+血清銅（亜鉛サプリ長期摂取者は半年-1年に1回の評価推奨）が論文整合的フィードバック設計です。\n\n亜鉛欠乏症状（味覚障害・脱毛・皮膚炎・免疫低下・前立腺機能低下）vs 過剰症状（銅欠乏・HDL低下・吐き気）の両側で評価する必要があります。',
    },
    {
      q: 'ビタミンC外用と経口どちらが皮膚老化に効く？',
      a: 'ヒトRCTでは外用15-20%が経口より直接的に皮膚改善エビデンス強い点が現実です。\n\nPinnell 2003 J Cosmet Sci RCT 15% L-アスコルビン酸外用×3ヶ月で色素沈着・しわ改善・Humbert 2003 Exp Dermatol 5% VC外用 vs 経口比較で外用優位・Traikovich 1999 Arch Otolaryngol 10% VC外用×3ヶ月で皮膚スコア改善が確立しています。\n\n皮膚VC濃度は表皮・真皮で血漿の100倍以上（Pullar 2017 Nutrients）で経口摂取での皮膚到達は限定的。\n\n外用15-20%（L-アスコルビン酸/3-O-エチルアスコルビン酸/アスコルビルリン酸ナトリウム/アスコルビン酸テトライソパルミテート）が論文ベースで皮膚老化対策の主軸です。\n\n経口ビタミンCはコラーゲン合成補因子として基盤的に重要（プロリン4-/リシン5-ヒドロキシラーゼ補因子）ですが、500-1,000mg/日で皮膚VC濃度上昇は緩やかで。\n\n「経口=ベース・外用=主軸」の補完設計が化粧品メーカー視点の現実解です。\n\n朝食時コラーゲンペプチド5g+ビタミンC500-1,000mg経口+夜VC15%外用が論文整合的階層。\n\n「経口ビタミンCで肌が白くなる」断定NGで外用VC・ナイアシンアミド5%・ハイドロキノン・トラネキサム酸の組合せが色素沈着対策の論文整合的選択肢です。',
    },
    {
  ...
  'palmitoyl-tripeptide-vs-retinol': [
    ...
    },
    {
      ...
      a: 'パルミトイルトリペプチドは妊娠中・授乳中も比較的安全な代替軸として論文整合的です。レチノールは経口高用量で催奇形性リスク（イソトレチノイン処方薬の催奇形性確立・FDA Pregnancy Category X）が確立しており、外用レチノールは経口より血中移行量が少ないものの妊娠中は念のため使用NG（ACOG 2024 guidance）の立場が一般的です。パルミトイルトリペプチドはペプチド構造で経皮吸収後の全身移行量が極めて少なく、催奇形性リスク報告なし・FDA Category 該当なし・妊娠中安全の代替軸として推奨されます。\n\n妊娠中の代替軸3本柱＝①ナイアシンアミド5%（Bissett 2005 RCT・妊娠中安全）、②ビタミンC 15%（L-アスコルビン酸・Pinnell 2001 抗酸化）、③パルミトイルトリペプチド（コラーゲン産生シグナル）が論文整合的。バクチオール（Bakuchiol）も植物性レチノール代替として注目されていますが、妊娠中の独立した安全性データは限定的のため、ACOG準拠ではナイアシンアミド/VC/ペプチドが第一選択です。',
    },
    {
      q: 'パルミトイルトリペプチドの効果が出るまでどれくらい？コラーゲン産生は本当に起きますか？',
      a: '12-24週の継続使用が論文整合的目安で、コラーゲン産生シグナル誘導はin vitro試験ベースのため期待値調整必須です。Robinson 2005 Int J Cosmet Sci メーカー協賛試験 Matrixyl® 3000 2%×12週でしわ改善が報告されていますが、ヒトでのコラーゲン産生実証は皮膚生検レベルの試験が限定的で、メーカー協賛試験の結果を慎重に解釈すべき領域です。\n\n「コラーゲンを増やしてくれる」訴求は科学的厳密には『コラーゲン産生シグナルが in vitro で確認されたペプチド』が論文整合的表現で、外用ペプチドが真皮深層に到達してコラーゲン産生を実質的に増やす量的エビデンスは未確立です。レチノールは皮膚生検レベルで真皮コラーゲン増加が確認されており（Kafi 2007 Arch Dermatol・Voorhees研グループ）、エビデンス階層では一段上です。\n\nペプチドはレチノールの代替ではなく補助レイヤーとして位置づけ、敏感肌・妊娠中・初心者で「とりあえずペプチド」の選択は合理的、本格的なエイジングケアではレチノール主軸が論文整合的です。',
    },
    {
      q: 'パルミトイルトリペプチドとレチノールの併用順序・スタック設計は？',
      a: '経路独立で併用OK・刺激リスクほぼゼロの組合せです。【スタック設計】①洗顔→化粧水→ナイアシンアミド5%セラム（バリア補強・色素沈着）→パルミトイルトリペプチドセラム（コラーゲン産生シグナル）→レチノール0.1-0.5%（夜のみ・ターンオーバー）→保湿クリーム→（朝のみ）日焼け止め SPF50+ PA++++が論文整合的順序です。【併用合理性】①経路独立＝ペプチド（シグナル経路・RAR非結合）+ レチノール（RAR/RXR結合・ターンオーバー）で機序重複なし、②刺激ほぼゼロ＝ペプチドはレチノールの赤み・乾燥を増悪させない（ナイアシンアミド・ペプチドはレチノールの刺激緩和補助）、③朝晩分離可能＝朝ペプチド+ナイアシンアミド+VC+日焼け止め、夜ペプチド+レチノール+保湿の使い分け。市販同時配合品（The Ordinary "Buffet" マルチペプチド+HA・La Roche-Posay Retinol B3 Serum・SkinCeuticals A.G.E. Interrupter）も普及しており、論文整合的設計です。月コスト¥6,000-15,000の組合せ範囲、3ヶ月以上の継続が前提です。',
    },
  ],
  'centella-asiatica-vs-niacinamide': [
    {
      q: 'ツボクサ（CICA）とナイアシンアミドの違いは？両者とも肌に優しい成分で混同しがちです',
      a: '作用ターゲットが完全に異なる補完関係です。ツボクサエキス（Centella Asiatica・CICA）は鎮静・抗炎症・創傷治癒の第一選択で、TECA標準化（asiaticoside 40% + asiatic acid 30% + madecassic acid 30%）が論文ベース。\n\nBonté 1994 Wound Repair Regen 創傷治癒in vitro試験・Ratz-Łyko 2016 J Cosmet Laser Ther ヒトRCT TECA抽出物しわ・水分改善・Pyo 2002 Phytother Res madecassoside抗炎症性確認・Bylka 2013 Postepy Dermatol Alergol レビューで「酒さ・脂漏性皮膚炎・敏感肌・赤み」の鎮静作用が論文蓄積、敏感肌・赤み・酒さの第一選択です。ナイアシンアミドはBissett 2005 J Cosmet Dermatol RCT 5%×8週で色素沈着・小じわ・皮脂・バリア機能の4方面改善が確認された多機能ビタミンB3で、補完関係です。',
    },
    {
      q: 'CICAとナイアシンアミドはどっちを選ぶ？敏感肌・赤み肌でも併用OK？',
      a: '症状で第一選択を決め、両者経路独立で併用OKです。【CICA優先】①赤み・酒さ・脂漏性皮膚炎・アトピー肌のバリア低下時（鎮静が最優先）、②ピーリング後・レーザー後の創傷治癒補助、③マスク荒れ・摩擦・刺激後の鎮静、④ニキビ炎症後の鎮静期。【ナイアシンアミド優先】①色素沈着・くすみ・PIH（炎症後色素沈着）、②毛穴開き・皮脂過剰、③バリア機能補強の中長期維持、④小じわ・初期エイジング。\n\n敏感肌順序＝CICA鎮静で炎症落ち着いてからナイアシンアミド多機能の段階性が現実解で、両者経路独立で併用OK、市販でもANUA Heartleaf 77 Toner + Niacinamide 10%セラム等の同時配合処方が韓国コスメ中心に普及。妊娠中も両者比較的安全で、ハイドロキノンの代替路線として論文整合的です。',
    },
    {
  ...
  'ramelteon-vs-melatonin': [
    ...
    },
    {
      ...
      a: '日本では医薬品扱いで国内サプリ流通なし。\n\n海外サプリの個人輸入は自己責任のグレーゾーンで本サイトは推奨する立場ではありません。【規制差】①米国・欧州＝メラトニンはDSHEA（Dietary Supplement Health and Education Act）健康食品扱いでOTC・スーパー・薬局で購入可（Nature Made・Now Foods・Life Extension・Costco Kirkland Signature等）、②カナダ・オーストラリア＝健康食品扱い、③日本＝医薬品扱いで国内サプリ流通なし・個人輸入は厚労省告示の自己使用範囲内（2ヶ月分以内）に限定、④個人輸入代行業者経由は薬機法上のグレーゾーンで品質保証も不確実。\n\n本サイトの立場＝①慢性不眠（毎晩3週間以上入眠潜時30分以上）→心療内科・睡眠外来受診→ラメルテオン処方検討、②概日リズム障害（時差ぼけ・交代勤務・DSWPD）→国内サプリ流通なし・睡眠外来受診、③軽症入眠困難→Mg-glycinate 200-400mg + グリシン3g + L-テアニン200mg の本サイト推奨スタックが論文整合的順序です。海外個人輸入での自己判断使用は推奨しません。',
    },
    {
  ...
  'centella-asiatica-vs-panthenol': [
    ...
    { q: '用量・形態の選び方は？', a: '【センテラアジアチカ】0.1-2%が論文用量再現。\n\nMadecassoside単離0.1%が高エビデンス（Bonté 1994 Planta Med・La Roche-Posay Cicaplast Baume B5 / Dr.Jart+ Cicapair Tiger Grass / SKIN1004 Madagascar Centella Asiatica 100 / COSRX Centella Blemish Cream等）、月¥2,000-6,000。【D-パンテノール】1-5%が論文用量再現（Ebner 2002）。\n\nLa Roche-Posay Cicaplast / Bepanthen / Eucerin Aquaphor等の医薬部外品レイヤー製品が主流、月¥1,500-4,000。\n\n塗布順序＝洗顔→化粧水→センテラ+パンテノール+ナイアシンアミド5%（CICA セラム）→保湿（セラミド+ヒアルロン酸）→SPF50+が論文整合的設計で。\n\nレチノール・AHA・BHA刺激後の鎮静ステップとして論文整合的。' },
    { q: 'CICA製品は本当に効果ある？マーケティングだけ？', a: '両者ともCICA領域で論文蓄積はあるが「劇的変化」エビデンスは限定的が誠実な立場。\n\nBonté 1994 Planta Medでマデカッソシドの抗炎症・コラーゲン合成促進が in vitro/動物試験で確立、Ratz-Łyko 2016で肌バリア改善ヒト試験あり、Ebner 2002でD-パンテノール5%皮膚バリア改善RCTあり。\n\nただし「敏感肌が劇的に治る」「酒さが治る」断定エビデンスはない。\n\n論文整合的位置づけ＝①刺激後の鎮静・修復補助（レチノール/AHA/BHA併用時）／②敏感肌・酒さの日常ケア基盤／③ニキビ後の修復／④バリア機能低下の補助でメイン治療ではなくサブシステム的補助レイヤー。\n\n酒さ・アトピー・乾癬は皮膚科第一選択（タクロリムス・コルチコステロイド・JAK阻害薬・イベルメクチン・処方ブリモニジン）でCICA成分は補助。' },
    { q: '併用注意は？妊娠中・授乳中は？', a: '【センテラアジアチカ】①稀に接触皮膚炎・パッチテスト推奨。\n\n②マデカッソシド/アジアチコシドのアレルギー稀。\n\n③妊娠中・授乳中の外用ほぼ安全レイヤー。\n\n④経口センテラ（伝統的アーユルヴェーダ）は肝毒性症例報告で経口避ける。\n\n⑤手術前1-2週間外用中止検討（理論的に血小板影響軽微）。【パンテノール】①極めて安全プロファイル（医薬品レベル）、②妊娠中・授乳中安全。\n\n③ベパンテン®（医薬品）は乳児・新生児にも使用可、④ほぼ全肌タイプ対応。\n\n⑤稀にラノリン併用品でラノリンアレルギー。「酒さが治る」「アトピーが治る」断定は薬機法/景表法NG・医療領域。' },
  ...
  'l-glutamine-vs-carnosine': [
    ...
    { q: '併用注意は？妊娠中・授乳中は？', a: '【L-グルタミン】①🚨肝機能低下例（肝硬変・肝性脳症既往）caution（アンモニア代謝で脳症増悪リスク・肝臓内科判断下）。\n\n②🚨腎機能低下例caution（eGFR<60で減量・腎臓内科判断下）。\n\n③🚨双極性障害・てんかん既往caution（グルタミン酸過剰刺激神経興奮性懸念）。\n\n④妊娠中・授乳中は標準的安全性データ限定で産科医相談下。\n\n⑤稀に消化器症状（軽度膨満感）、⑥がん患者caution（腫瘍細胞増殖促進懸念・腫瘍内科判断下・特定がん種で議論）。【カルノシン】①極めて安全プロファイル、②稀に消化器症状。\n\n③妊娠中・授乳中の標準的安全性データ限定で産科医相談下。\n\n④亜鉛キレート型（Polaprezinc・プロマック®処方薬胃潰瘍治療薬）は別物で胃潰瘍は消化器内科第一選択。\n\n⑤β-アラニン代替時はparesthesia（ピリピリ感）が論文整合的。「リーキーガットが治る」「老化が止まる」「アンチエイジング」断定は薬機法/景表法NG。' },
    { q: '効果が出るまでと評価のタイミングは？', a: '【L-グルタミン】2-8週で評価（Zhou 2019 8週・Rao 2012レビュー）、累積効果型で評価指標＝①IBS-SSS（IBS Symptom Severity Score）／②腸透過性指標（Lactulose/Mannitol比・専門検査）／③便回数・性状／④腹部膨満・痛み／⑤主観的疲労感・運動回復、8週で効果限定的なら①消化器内科受診（IBD/セリアック病/SIBO/IBS鑑別）／②食事軸（低FODMAP・グルテン回避・乳製品・添加物）／③ストレス管理（CBT・マインドフルネス）／④プロバイオティクス併用（LGG/S. boulardii/VSL#3®）。【カルノシン】4-12週で評価（Hipkiss 2009レビュー）、評価指標＝①AGEs指標（HbA1c・グリコアルブミン・専門検査でCML/ペントシジン）／②抗酸化指標（MDA・8-OHdG・hs-CRP）／③主観的疲労感・運動パフォーマンス／④しわ・キメ（VISIA）。\n\n累積効果型でβ-アラニン代替が論文整合的で経口カルノシン単独評価困難です。' },
  ],
  'akkermansia-vs-inulin': [
  ...
  'beta-alanine-vs-l-citrulline': [
    ...
    { q: '用量・形態の選び方は？', a: '【β-アラニン】3.2-6.4g/日が論文用量再現（Saunders 2017 メタ・ISSN Position Stand 2015）。\n\n🚨1回1.6g以下分割摂取でparesthesia（ピリピリ感）軽減。\n\n徐放型CarnoSyn®/SR CarnoSyn®（NAI社特許製法）が論文用量再現の規格化原料。\n\nNow Foods Beta-Alanine Powder / Optimum Nutrition Beta-Alanine / NutraBio Beta-Alanine Carnosyn®等、月¥1,500-3,500。【L-シトルリン】運動前6-8g（純粋型）/ 8-10g（マレート型1:1 or 2:1比）が論文用量再現。\n\nシトルリンマレート（プレワーク用途・乳酸クリアランス）vs 純粋L-シトルリン（維持・血流NO産生）。\n\nKyowa Quality™ L-Citrulline（協和発酵バイオ）規格化原料。\n\nNow Foods L-Citrulline / Sports Research Citrulline Malate / Bulk Supplements Citrulline Malate 2:1等、月¥2,000-4,500。\n\n摂取タイミング＝β-アラニン分割摂取（朝・運動前・夜の3回）+ シトルリン運動前30-60分（空腹時）。' },
    { q: '併用OK？プレワークスタックの最適解は？', a: '併用OKでプレワーク総合スタックがISSN Position Stand 2015で論文整合的設計＝①β-アラニン3.2-6.4g/日（分割・累積効果型）+②シトルリンマレート6-8g（運動前30-60分・即時効果型）+③クレアチンモノハイドレート5g/日（運動後+食事と同時・累積効果型）+④カフェイン200-400mg（運動前30-60分・即時覚醒・パフォーマンス向上）+⑤ホエイプロテイン20-40g（運動後30分以内・筋合成）+⑥水分1.5-2L/日厳守が4-6成分スタック。\n\nTrexler 2015 J Int Soc Sports Nutr Position Statementで4-6成分マルチスタックの相乗効果確立。' },
    { q: '併用注意は？妊娠中・授乳中は？', a: '【β-アラニン】①paresthesia（ピリピリ感・15-20分・無害）で1回1.6g以下分割摂取で軽減。\n\n②妊娠中・授乳中は標準的安全性データ限定で産科医相談下、③タウリン併用注意（β-アラニン高用量でタウリン取り込み阻害理論的懸念・Dolan 2018だがヒトデータ限定）、④腎機能低下例caution（eGFR<60で減量・腎臓内科判断下）、⑤稀に消化器症状。【L-シトルリン】①🚨降圧薬caution（血圧低下作用報告・Wong 2016 Br J Nutrメタ）。\n\n②🚨PDE5阻害薬（バイアグラ®・シアリス®）併用caution（NO/cGMP経路重畳で過度の血圧低下）。\n\n③🚨硝酸薬（ニトログリセリン・ISDN）併用禁忌（過度の血圧低下+ショック）、④妊娠中・授乳中はデータ限定で産科医相談下。\n\n⑤ヘルペス活動性期caution（理論的にアルギニン代謝経路で複製サポート懸念・リジン代替推奨）、⑥手術前1-2週間中止検討。「マッチョになる」「ムキムキになる」断定は薬機法/景表法NG→「持久力・パンプ・運動効率改善が報告」型統一が論文整合的。' },
    { q: '効果が出るまでと評価のタイミングは？', a: '【β-アラニン】4-8週で評価（Saunders 2017 メタ・Hoffman 2008 4-6週）、累積効果型で評価指標＝①持久力テスト（1-4分高強度・サイクリングTT・ローイング）／②反復回数（8-12RM）／③主観的疲労感／④筋カルノシン濃度（専門検査・MRS）。【L-シトルリン】急性効果＝摂取30-60分後にNO上昇・血流増加・パンプ感（Bailey 2010）。\n\n1-2週で持久力・運動効率改善（Suzuki 2016）、評価指標＝プレワーク主観（パンプ・反復回数・疲労感）+持久力テスト（VO2max・LT・タイムトライアル）。\n\n効果限定的なら①用量増量（β-アラニン3.2→6.4g/日・シトルリン6→10g/日）／②形態切替（純粋→マレート型→徐放型）／③併用追加（クレアチン+カフェイン+ホエイ）／④トレーニング負荷見直し（漸進性過負荷・ボリューム・強度）／⑤栄養軸（タンパク質1.6-2.2g/kg・カロリー収支）／⑥睡眠7-9時間が次のステップです。' },
  ],
  'tongkat-ali-vs-ashwagandha': [
  ...
  'creatine-vs-beta-alanine': [
    ...
    { q: '用量・形態・併用スタックの最適解は？', a: '【クレアチン】5g/日（維持用量）or ローディング20g/日×5-7日→維持5g/日。\n\nCreapure®（AlzChem社・ドイツ）規格化原料が論文用量再現の前提（純度99.99%・他形態HCl/ナイトレート/エチルエステルはCrMを凌駕するエビデンスなし）。\n\nNow Foods Creatine Monohydrate Pure Powder (Creapure®) / Optimum Nutrition Micronized Creatine (Creapure®) / Jarrow Formulas Creatine Monohydrate (Creapure®)等、月¥1,500-3,500。【β-アラニン】3.2-6.4g/日（1.6g以下分割摂取でparesthesia軽減）。\n\nCarnoSyn®/SR CarnoSyn®規格化原料。\n\nNow Foods Beta-Alanine / NutraBio Beta-Alanine CarnoSyn®等、月¥1,500-3,500。\n\n論文整合的併用スタック＝①クレアチン5g/日（運動後+食事と同時・累積効果型）+②β-アラニン3.2-6.4g/日（分割摂取・累積効果型）+③シトルリンマレート6-8gプレワーク（即時効果型）+④カフェイン200-400mg（プレワーク）+⑤ホエイプロテイン20-40g運動後+⑥水分1.5-2L/日が4-6成分マルチスタック（Trexler 2015 ISSN Position Statement）。' },
    { q: 'どちらが筋力UPに効く？トレーニング目的別の選び方', a: '【最大筋力・パワー・除脂肪体重UP（パワーリフティング・短時間スプリント）】＝クレアチン主軸（Kreider 2017メタ解析・Branch 2003で1RM +8%・除脂肪体重+1.3kg報告）、β-アラニンは効果限定的。\n\n【中強度持久力UP（1-4分高強度・サイクリングTT・ローイング・600m走・水泳）】＝β-アラニン主軸（Hoffman 2008・Saunders 2017メタ・筋カルノシン濃度上昇でH+緩衝能改善）、クレアチンは限定的。\n\n【総合的筋トレ・ボディビル・除脂肪体重維持】＝両者併用（時間軸補完・併用の相乗効果Trexler 2015 ISSN Position Statement）。\n\n【格闘技・MMA・水泳・自転車競技】＝両者併用 + シトルリンマレート + カフェイン。\n\n【🚨重要】＝「クレアチン単独で筋力↑」「β-アラニン単独で持久力↑」を期待する前にトレーニング負荷（漸進性過負荷の原則）・タンパク質1.6-2.2g/kg体重/日・睡眠7-9時間・カロリー収支が論文整合的最強軸でサプリは補助レイヤー。' },
    { q: '併用注意は？妊娠中・授乳中は？', a: '【クレアチン】①水分保持で体重+1-2kg（筋内グリコーゲン+水分・体脂肪増加ではない）。\n\n②胃腸障害（嘔気・腹部膨満・下痢）で水分1.5-2L/日+食事と同時+分割摂取（5g×2回/日）で軽減、③稀に筋けいれん・脱水（高用量+水分不足）。\n\n④🚨腎機能低下例（eGFR<60・透析患者）caution（腎臓内科判断下・健常人は安全プロファイル良好・Lopez 2009メタ）。\n\n⑤糖尿病・GFR低下は念のためモニター、⑥肝機能影響データなしで長期使用安全。\n\n⑦妊娠中・授乳中は標準的安全性データ限定で産科医相談下。\n\n⑧カフェイン併用は古典的に「効果相殺懸念」報告（Vandenberghe 1996）だが近年RCTで否定的（Trexler 2016 ISSNメタ）。【β-アラニン】①paresthesia（ピリピリ感）で1回1.6g以下分割摂取で軽減。\n\n②妊娠中・授乳中は標準的安全性データ限定で産科医相談下、③タウリン併用注意（理論的取り込み阻害・Dolan 2018）、④腎機能低下例caution、⑤稀に消化器症状。「マッチョになる」「ムキムキになる」「100kg挙げられる」断定は薬機法/景表法NG。' },
    { q: '効果が出るまでと評価のタイミングは？', a: '【クレアチン】急性効果＝ローディング後5-7日で筋内Cr貯蔵量飽和（Hultman 1996 20g/日×5日で筋内Cr+20%）。\n\n中長期効果＝4-12週で筋力+8%・筋量+1.3kg（Branch 2003 96 RCTメタ・Rawson 2003 メタ）、評価指標＝1RM・8-12RM反復回数・除脂肪体重（DXA・BIA）・筋周囲径。【β-アラニン】4-8週で評価（Saunders 2017 メタ）、評価指標＝1-4分高強度持久力テスト・反復回数・主観的疲労感。\n\n12-16週で効果限定的なら①トレーニング負荷見直し（漸進性過負荷・ボリューム・強度・頻度・休息）／②栄養軸（タンパク質1.6-2.2g/kg・カロリー収支・炭水化物タイミング）／③睡眠7-9時間／④回復（連続トレーニング日数・アクティブリカバリー）／⑤医療領域（変形性関節症・腱鞘炎・椎間板ヘルニア・五十肩は整形外科+理学療法・男性更年期LOHは内分泌内科・サルコペニアは栄養+運動+リハビリ）／⑥生活軸（喫煙・大量飲酒・慢性ストレス）が次のステップです。' },
  ],
  'fadogia-agrestis-vs-tongkat-ali': [
