    ...
    ingredients: [
      {
        ...
        evidenceRank: 'S',
        urgencyNote: 'コラーゲン産生は25歳以降毎年約1%低下し続ける。使い始めが早いほど、低濃度で高い効果が得られる。',
...
初めて試すなら2〜3%の製品でスキンケアへの馴染み方を確認し、問題なければ5%に移行するのが合理的だ。ほとんどの肌質で刺激が少なく継続しやすいという点が、ナイアシンアミドの最大の実用的メリットだ。`,
  ...
  // ── 12. アシュワガンダ詳細ガイド ──────────────────────────────────────
  {
    ...
    title: 'アシュワガンダのエビデンスを整理する。ストレス・睡眠・筋力—どれが本当に効くのか',
    description:
      'アシュワガンダのRCTエビデンスを「ストレス」「睡眠」「筋力」「性機能」「認知」の5領域別に整理。KSM-66とSensorilの違い、有効量の正しい理解まで論文で解説。',
    category: 'supplement',
    categoryLabel: 'サプリ入門',
