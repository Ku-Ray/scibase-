...
export const ingredients: Ingredient[] = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: 'ProOmega EPA 650mg/DHA 450mg 60粒',
        brand: 'Nordic Naturals',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/dp/B000Z94IVS?tag=scibase-22',
        priceJpy: 3000,
        rank: 3,
        reasonJa: 'IFOS認証取得。EPA・DHA含有量が明記された高純度フィッシュオイル。Prime対応',
        highlight: 'Prime即配',
        monthlyCostJpy: 2000,
        form: 'ソフトジェル',
      },
    ...
    products: [
      {
        ...
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/Vital-Proteins/dp/B09DD9ZQNP?tag=scibase-22',
        priceJpy: 4800,
        dosageMg: 20000,
        rank: 1,
    ...
    products: [
      {
        ...
        brand: 'The Ordinary',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/-/en/Ordinary-Retinol-0-2-Squalane-30ml/dp/B077DWJ4H5?tag=scibase-22',
        priceJpy: 1600,
        rank: 1,
