...
export const ingredients: Ingredient[] = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: 'マグネシウム グリシン酸キレート',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=マグネシウム+グリシン酸+キレート+サプリ&tag=scibase-22',
        priceJpy: 2500,
        rank: 2,
        reasonJa: '国内発送・Prime対応。グリシン酸キレートまたはグリシネートMgを選ぶと吸収率が高い',
        highlight: 'Prime即配',
        monthlyCostJpy: 2500,
        form: 'カプセル',
      },
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: 'ビタミンD3 2000IU サプリ',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=ビタミンD3+2000IU+サプリ&tag=scibase-22',
        priceJpy: 1500,
        rank: 2,
        reasonJa: 'D3形態（コレカルシフェロール）を選ぶのがポイント。国内Primeで翌日届く',
        highlight: 'Prime即配',
        monthlyCostJpy: 800,
        form: 'ソフトジェル',
      },
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: 'EPA DHA オメガ3 フィッシュオイル',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=EPA+DHA+フィッシュオイル+1000mg&tag=scibase-22',
        priceJpy: 3000,
        rank: 3,
        reasonJa: '国内Prime対応。EPA+DHA合計量の記載がある製品を選ぶのがポイント',
        highlight: 'Prime即配',
        monthlyCostJpy: 2000,
        form: 'ソフトジェル',
      },
...

  {
    ...
    products: [
      ...
      {
        name: 'テアニン 200mg Suntheanine',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=テアニン+200mg+Suntheanine&tag=scibase-22',
        priceJpy: 2500,
        rank: 2,
        reasonJa: 'Suntheanine規格（特許取得L-テアニン）の製品を選ぶのがポイント。Prime対応で国内即配',
        highlight: 'Prime即配',
        monthlyCostJpy: 2000,
        form: 'カプセル',
      },
...

  {
    ...
    products: [
      ...
      {
        name: 'グリシン 3000mg 粉末・カプセル',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=グリシン+3000mg+サプリ&tag=scibase-22',
        priceJpy: 1500,
        rank: 2,
        reasonJa: '国内ブランドも多数展開。就寝前3gを取れる用量設計の製品を選ぶのがポイント',
        highlight: 'Prime即配',
        monthlyCostJpy: 1500,
        form: 'カプセル・粉末',
      },
...

  {
    ...
    products: [
      ...
      {
        name: 'クレアチンモノハイドレート パウダー',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=クレアチン+モノハイドレート+パウダー+1kg&tag=scibase-22',
        priceJpy: 2500,
        rank: 2,
        reasonJa: 'Creapure（ドイツ産）規格またはモノハイドレート100%の製品を選ぶのがポイント。Prime即日配送',
        highlight: 'Prime即配',
        monthlyCostJpy: 700,
        form: '粉末',
      },
    ...
    products: [
      {
        ...
        brand: 'Dr.Jart+',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=Dr.Jart+シカペア&tag=scibase-22',
        priceJpy: 2800,
        rank: 1,
    ...
    products: [
      {
        ...
        brand: 'The Ordinary',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=The+Ordinary+スクワラン&tag=scibase-22',
        priceJpy: 1500,
        rank: 1,
    ...
    products: [
      {
        ...
        brand: 'The Ordinary',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=The+Ordinary+乳酸&tag=scibase-22',
        priceJpy: 1200,
        rank: 1,
  ...
  // ── Batch 2: メジャーサプリ ──────────────────────────────────────────
  {
    ...
    products: [
      ...
      {
        name: 'アスタキサンチン 4〜12mg ヘマトコッカス藻由来',
        brand: 'Amazon検索',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=アスタキサンチン+ヘマトコッカス+4mg&tag=scibase-22',
        priceJpy: 2500,
        rank: 2,
        reasonJa: '国内ブランド多数展開（富士フイルム等）。ヘマトコッカス藻由来・4mg以上を選ぶのがポイント',
        highlight: 'Prime即配',
        monthlyCostJpy: 2500,
        form: 'ソフトジェル',
      },
    ...
    products: [
      {
        ...
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=spermidine+supplement&tag=scibase-22',
        priceJpy: 6000,
        dosageMg: 1,
        rank: 1,
    ...
    products: [
      {
        ...
        brand: 'ChromaDex',
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=TRU+NIAGEN+nicotinamide+riboside&tag=scibase-22',
        priceJpy: 8000,
        dosageMg: 300,
        rank: 1,
    ...
    products: [
      {
        ...
        platform: 'amazon',
        url: 'https://www.amazon.co.jp/s?k=alpha+ketoglutarate+supplement&tag=scibase-22',
        priceJpy: 4500,
        dosageMg: 1000,
        rank: 1,
...
export const concerns: Concern[] = [
  {
    ...
    ingredientSlugs: ['collagen-peptide', 'niacinamide', 'omega3', 'coq10', 'nmn', 'resveratrol', 'astaxanthin', 'tranexamic-acid', 'centella-asiatica', 'lactic-acid', 'egcg', 'vitamin-e', 'equol', 'soy-isoflavones', 'ferulic-acid', 'evening-primrose-oil', 'mandelic-acid', 'sulforaphane', 'placenta', 'glutathione', 'carnosine'],
  },
  {
    slug: 'wrinkles',
    nameJa: 'シワ・たるみ',
  ...
  },
  {
    ...
    ingredientSlugs: ['omega3', 'creatine', 'l-theanine', 'lions-mane', 'phosphatidylserine', 'ginkgo-biloba', 'egcg', 'curcumin', 'taurine', 'fisetin', 'spermidine', 'iron', 'vitamin-b12', 'vitamin-b6', 'acetyl-l-carnitine', 'bacopa-monnieri', 'panax-ginseng', 'alpha-gpc', 'pqq', 'folic-acid', 'niacin', 'carnosine'],
  },
  {
    slug: 'inflammation',
    nameJa: '体の慢性炎症',
    ...
    ingredientSlugs: ['omega3', 'vitamin-d', 'coq10', 'resveratrol', 'curcumin', 'egcg', 'quercetin', 'berberine', 'alpha-lipoic-acid', 'astaxanthin', 'vitamin-e', 'selenium', 'l-arginine', 'glucosamine', 'chondroitin', 'butyrate', 'spirulina', 'evening-primrose-oil', 'l-glutamine', 'sulforaphane', 'nattokinase', 'beta-glucan', 'glutathione'],
  },
  {
    slug: 'gut',
    nameJa: '腸内環境',
  ...
  },
  {
    ...
    ingredientSlugs: ['ceramide', 'hyaluronic-acid', 'niacinamide', 'centella-asiatica', 'squalane', 'panthenol', 'allantoin', 'evening-primrose-oil', 'pdrn'],
  },
  {
    slug: 'dry-skin',
    nameJa: '乾燥肌・保湿',
  ...
  },
  {
    ...
    ingredientSlugs: ['berberine', 'alpha-lipoic-acid', 'egcg', 'nicotinamide-riboside', 'alpha-ketoglutarate', 'folic-acid', 'vitamin-b6', 'l-citrulline', 'equol', 'soy-isoflavones', 'inulin', 'spirulina', 'tmg', 'niacin', 'hmb', 'myo-inositol', 'akkermansia', 'carnosine'],
  },
  {
    slug: 'longevity',
    nameJa: '長寿・細胞老化',
    ...
    ingredientSlugs: ['quercetin', 'fisetin', 'spermidine', 'nicotinamide-riboside', 'alpha-ketoglutarate', 'nmn', 'resveratrol', 'urolithin-a', 'pqq', 'tmg', 'acetyl-l-carnitine', 'sulforaphane', 'hmb', 'nattokinase', 'akkermansia', 'carnosine'],
  },
  {
    slug: 'eye-health',
    nameJa: '目の老化・眼の健康',
