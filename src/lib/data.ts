    ...
    products: [
      {
        ...
        pros: [
          'タウリンは含硫アミノ酸で肝・心・神経機能に必須',
          '1食1gで研究使用量下限（500-3000mg/日）',
          '454g大容量で約15ヶ月分（¥120/月）と最安レベル',
          'NOW Foods GMP・第三者検査済み',
        ],
        cons: [
          '高用量で消化器症状・血圧低下が出やすい',
          'ベンゾジアゼピン系・抗てんかん薬と相互作用',
          '粉末特有の苦味あり',
        ],
      },
    ],
    ...
    products: [
      {
        ...
        pros: [
          'Host DefenseはPaul Stamets博士監修の老舗キノコブランド',
          '1日1g（1カプセル）で研究使用量下限（500-3000mg/日）',
          'USDA Organic + Non-GMO Project Verified',
          '神経成長因子（NGF）産生促進RCTで認知機能改善報告',
        ],
        cons: [
          '効果実感まで12-16週の継続が必要',
          'キノコアレルギーの方は使用不可',
    ...
    products: [
      {
        ...
        pros: [
          'Phytosome技術はリン脂質結合で吸収率を約20倍に向上',
          '1カプセル500mgで研究使用量下限（500-1000mg/日）',
          'Thorne NSF認証・原料純度公開で最高クラス',
          'ビタミンCとの併用で抗酸化相乗効果',
        ],
        cons: [
          '抗凝固薬との併用で出血リスク増',
    ...
    products: [
      {
        ...
        pros: [
          'L-アルギニンはNO合成経路を介して血流改善に作用',
          '1錠1000mg・3粒で研究使用量下限（3-6g/日）',
          '単純アミノ酸で安全域が広い',
          'NOW Foods GMP・第三者検査済み',
        ],
        cons: [
          'ヘルペス再活性化リスク（リジンとのバランス重要）',
          '降圧薬・ED薬と併用で過度な血圧低下リスク',
          '海外発送で到着まで7-14日',
        ],
      },
    ],
    ...
    products: [
      {
        ...
        pros: [
          'グルコサミン硫酸塩はメタ解析で関節軟骨保護効果',
          '750mg×2粒で研究使用量（1500mg/日）を満たす',
          '360粒で約6ヶ月分（¥630/月）と長期コスパ良好',
          'Doctor\'s Best 第三者検査・GMP認証',
        ],
        cons: [
          '甲殻類アレルギーの方は禁忌',
    ...
    products: [
      {
        ...
        pros: [
          '3成分複合で関節サポート研究の標準的な配合',
          '1日3錠で研究使用量レンジ（コンドロイチン800-1200mg）',
          'Solgar 1947年創業・第三者検査公開',
          '単独成分より複合製剤の方がメタ解析で優位の報告',
        ],
        cons: [
          '甲殻類アレルギーの方は事前に確認',
          '抗凝固薬と併用で出血リスク増',
    ...
    products: [
      {
        ...
        pros: [
          '日本人の約半数はエクオール非産生菌型でこのサプリが直接補充手段',
          '大塚製薬の発酵特許で大豆胚芽から生成される正規エクオール',
          '1日4粒で更年期症状RCT用量（10mg/日）',
          '国内製造・薬機法準拠・ドラッグストア入手可能',
        ],
        cons: [
          'ホルモン感受性疾患（乳がん等）の既往ある方は要相談',
          '価格は¥3,600/月と国内サプリでは高め',
          '効果実感まで4-12週の継続が必要',
        ],
      },
    ],
    ...
    products: [
      {
        ...
        pros: [
          '1カプセル150mg(アグリコン60mg)で研究使用量上限（50-100mg/日）',
          '大豆発酵濃縮エキスで吸収効率に配慮',
          '120粒で約4ヶ月分（¥550/月）',
          'NOW Foods GMP・第三者検査済み',
        ],
    ...
    products: [
      {
        ...
        pros: [
          'Alpha-GPCはコリン誘導体の中で最も生体利用率が高い',
          '1カプセル300mgで研究使用量下限（300-600mg/日）',
          '認知症RCTで使用実績あり',
          'NOW Foods GMP認証',
        ],
        cons: [
          '抗コリン薬・ベンゾジアゼピンと相互作用報告',
          '高用量で頭痛・胃腸症状が出ることがある',
          '海外発送で到着まで7-14日',
        ],
      },
    ...
    products: [
      {
        ...
        pros: [
          'BioPQQ®は三菱ガス化学（日本）の特許取得・発酵法製造',
          '1カプセル20mgで研究使用量上限（10-20mg/日）',
          'ミトコンドリア新生促進・認知機能改善RCT',
          'Life Extension GMP・第三者検査公開',
        ],
        cons: [
          '価格は¥3,500/月とプレミアム帯',
          '長期安全性データはまだ蓄積中',
    ...
    products: [
      {
        ...
        pros: [
          'TMGはホモシステイン代謝を直接サポートするメチル基ドナー',
          '1カプセル1000mgで研究使用量下限（1-3g/日）',
          '心血管リスクマーカー改善RCT実績',
          'NOW Foods GMP認証',
        ],
        cons: [
          '高用量で胃腸症状・体臭変化が出ることがある',
          'メトトレキサート服用中は医師相談',
          '海外発送で到着まで7-14日',
        ],
      },
    ...
    products: [
      {
        ...
        pros: [
          '月見草油はGLA（γ-リノレン酸）の主要供給源',
          '1ソフトジェル1300mgで研究使用量下限（1-3g/日）',
          '300粒で約10ヶ月分（¥280/月）と最安レベル',
          'NOW Foods GMP認証',
        ],
        cons: [
          '抗凝固薬と併用で出血リスク増',
    ...
    products: [
      {
        ...
        pros: [
          'Myrosinase酵素併配で胃でスルフォラファンに直接変換される処方',
          '体内変換型の他社製品より生体利用率が高い',
          '1カプセル/日で抗酸化・解毒酵素誘導RCT用量',
          'Jarrow Formulas GMP・第三者検査済み',
        ],
        cons: [
          '高用量で胃腸症状・甲状腺機能影響の可能性',
          '抗凝固薬と併用で出血リスク増',
          '海外発送で到着まで7-14日',
        ],
      },
    ...
    products: [
      {
        ...
        pros: [
          '納豆菌培養から精製したフィブリン分解酵素',
          '1カプセル2000FUで研究使用量レンジ（2000-4000FU/日）',
          'Doctor\'s Best 第三者検査・GMP認証',
          '90粒で約3ヶ月分（¥1,270/月）',
        ],
        cons: [
          '抗凝固薬・抗血小板薬と併用で出血リスク増',
          '手術前2週間は休薬必須',
          '妊娠中・潰瘍のある方は禁忌',
          '海外発送で到着まで7-14日',
        ],
    ...
    products: [
      {
        ...
        pros: [
          'L-カルノシンは抗糖化（AGE生成抑制）作用が報告される稀な成分',
          '500mg×2で研究使用量下限（1000-2000mg/日）',
          '動物実験で寿命延伸・人での認知機能改善報告',
          'NOW Foods GMP認証',
        ],
        cons: [
          '大量摂取で腸内菌バランスへの影響可能性',
    ...
    products: [
      {
        ...
        pros: [
          'アピゲニンはGABA-A受容体に弱く結合し鎮静作用が報告される',
          '1カプセル50mgで研究使用量下限（50-100mg/日）',
          'David Sinclair研究室で取り上げられた抗老化候補',
          'NOW Foods GMP認証',
        ],
        cons: [
          '抗凝固薬・降圧薬と相互作用報告',
    ...
    products: [
      {
        ...
        pros: [
          'プテロスチルベンはレスベラトロールより脂溶性が高く吸収率約4倍',
          '半減期が長く血中濃度を維持しやすい',
          '1カプセル50mgで研究使用量下限（50-200mg/日）',
    ...
    products: [
      {
        ...
        pros: [
          'シリマリン80%標準化エキスで肝保護メタ解析使用域',
          '1カプセル300mgで研究使用量下限（280-600mg/日）',
          '200粒で約6.7ヶ月分（¥450/月）と最安レベル',
          'NOW Foods GMP認証',
        ],
        cons: [
          'キク科アレルギーの方は注意',
    ...
    products: [
      {
        ...
        pros: [
          '320mg/日は欧州BPH治療ガイドラインで使われる標準用量',
          '1ソフトジェルで研究使用量下限を満たす',
          '85-95%脂肪酸標準化エキスで品質保証',
          'NOW Foods GMP認証',
        ],
        cons: [
          '抗凝固薬・テストステロン薬と相互作用',
    ...
    products: [
      {
        ...
        pros: [
          '経口ヒアルロン酸は皮膚水分量改善RCTで使用実績',
          '1カプセル100mgで研究使用量レンジ中央値（80-200mg/日）',
          '60粒で約2ヶ月分（¥1,500/月）',
          'NOW Foods GMP認証',
        ],
        cons: [
    ...
    products: [
      {
        ...
        pros: [
          'ch-OSA®（コリン安定化オルトケイ酸）は唯一吸収可能なシリカ形態',
          '1カプセル5mgで研究使用量下限（10-40mg/日相当の生体利用量）',
          'コラーゲン産生・髪・爪・骨密度RCT実績',
          '特許取得形態で他社では入手不可',
        ],
        cons: [
          '価格は¥2,500/月とやや高め',
    ...
    products: [
      {
        ...
        pros: [
          'ピコリネート型は吸収率が高くインスリン感受性RCT使用実績',
          '1カプセル200mcgで研究使用量下限（200-1000mcg/日）',
          '250粒で約8.3ヶ月分（¥240/月）と最安レベル',
          'NOW Foods GMP認証',
        ],
        cons: [
          '高用量長期で腎機能・肝機能影響の症例報告',
          '糖尿病薬と併用で低血糖リスク',
          '海外発送で到着まで7-14日',
        ],
      },
    ...
    products: [
      {
        ...
        pros: [
          'ニゲラ種子油はチモキノンを含む伝統医学使用の油脂',
          '1ソフトジェル1000mgで研究使用量レンジ（500-2000mg/日）',
          'コールドプレス（低温抽出）で活性成分保持',
          '抗炎症・血糖・脂質改善RCT実績',
        ],
        cons: [
          '抗凝固薬・降圧薬・糖尿病薬と相互作用',
    ...
    products: [
      {
        ...
        pros: [
          'フィセチンは老化細胞除去（セノリティクス）研究で最も注目される',
          'イチゴ・りんごに含まれる天然フラボノイド',
          '1カプセル100mgで研究使用量下限（100-500mg/日）',
          'Doctor\'s Best 第三者検査・GMP認証',
        ],
        cons: [
          'ヒトRCTはまだ規模が限定的',
    ...
    products: [
      {
        ...
        pros: [
          'マカはペルー高地原産・テストステロン非介在の作用機序',
          '500mg×3粒で研究使用量下限（1500-3500mg/日）',
          'USDA Organic 認証・GMP製造',
          'ホルモン感受性疾患でも比較的安全とされる',
        ],
        cons: [
          '妊娠中・甲状腺疾患の方は要医師相談',
          '効果実感まで4-12週の継続が必要',
