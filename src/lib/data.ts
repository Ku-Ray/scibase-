...
export const concerns: Concern[] = [
  {
    ...
    ingredientSlugs: ['collagen-peptide', 'niacinamide', 'omega3', 'coq10', 'nmn', 'resveratrol', 'astaxanthin', 'tranexamic-acid', 'centella-asiatica', 'lactic-acid', 'egcg', 'vitamin-e'],
  },
  {
    slug: 'wrinkles',
    nameJa: 'シワ・たるみ',
    ...
    ingredientSlugs: ['collagen-peptide', 'niacinamide', 'retinol', 'retinal', 'bakuchiol', 'copper-peptide'],
  },
  {
    slug: 'sleep',
    nameJa: '睡眠の質',
  ...
  },
  {
    ...
    ingredientSlugs: ['ashwagandha', 'l-theanine', 'magnesium', 'gaba', 'rhodiola', 'phosphatidylserine'],
  },
  {
    slug: 'fatigue',
    nameJa: '疲れやすい',
    ...
    ingredientSlugs: ['coq10', 'creatine', 'magnesium', 'ashwagandha', 'glycine', 'nmn', 'taurine', 'rhodiola', 'nicotinamide-riboside', 'iron', 'alpha-lipoic-acid', 'alpha-ketoglutarate'],
  },
  {
    slug: 'cognitive',
    nameJa: '認知・集中力',
    ...
    ingredientSlugs: ['omega3', 'creatine', 'l-theanine', 'lions-mane', 'phosphatidylserine', 'ginkgo-biloba', 'egcg', 'curcumin', 'taurine', 'fisetin', 'spermidine', 'iron'],
  },
  {
    slug: 'inflammation',
    nameJa: '体の慢性炎症',
    ...
    ingredientSlugs: ['omega3', 'vitamin-d', 'coq10', 'resveratrol', 'curcumin', 'egcg', 'quercetin', 'berberine', 'alpha-lipoic-acid', 'astaxanthin', 'vitamin-e', 'selenium'],
  },
  {
    slug: 'gut',
    nameJa: '腸内環境',
  ...
  },
  {
    ...
    ingredientSlugs: ['vitamin-d', 'probiotics', 'vitamin-c-oral', 'zinc', 'quercetin', 'egcg', 'selenium', 'vitamin-e'],
  },
  {
    slug: 'spots',
    nameJa: 'シミ・色素沈着',
    ...
    ingredientSlugs: ['arbutin', 'niacinamide', 'vitamin-c-topical', 'azelaic-acid', 'kojic-acid', 'glycolic-acid', 'tranexamic-acid', 'lactic-acid'],
  },
  {
    slug: 'barrier',
    nameJa: 'バリア機能・乾燥',
    ...
    ingredientSlugs: ['ceramide', 'hyaluronic-acid', 'niacinamide', 'centella-asiatica', 'squalane'],
  },
  {
    slug: 'dry-skin',
    nameJa: '乾燥肌・保湿',
    ...
    ingredientSlugs: ['ceramide', 'hyaluronic-acid', 'collagen-peptide', 'squalane', 'lactic-acid'],
  },
  {
    slug: 'acne',
    nameJa: 'ニキビ・肌荒れ',
    ...
    ingredientSlugs: ['salicylic-acid', 'azelaic-acid', 'niacinamide', 'zinc', 'retinal', 'centella-asiatica'],
  },
  {
    slug: 'pores',
    nameJa: '毛穴・テクスチャー',
    ...
    ingredientSlugs: ['salicylic-acid', 'glycolic-acid', 'niacinamide', 'retinol', 'lactic-acid'],
  },
  {
    slug: 'uv-damage',
    nameJa: '光老化・UVダメージ',
    ...
    ingredientSlugs: ['retinol', 'vitamin-c-topical', 'niacinamide', 'arbutin', 'kojic-acid', 'resveratrol', 'astaxanthin', 'tranexamic-acid', 'vitamin-e'],
  },
  {
    slug: 'hair',
    nameJa: '髪・爪',
  ...
  },
  {
    ...
    ingredientSlugs: ['vitamin-d', 'collagen-peptide', 'vitamin-k2'],
  },
  {
    slug: 'metabolism',
    nameJa: '代謝・血糖コントロール',
    ...
    ingredientSlugs: ['berberine', 'alpha-lipoic-acid', 'egcg', 'nicotinamide-riboside', 'alpha-ketoglutarate'],
  },
  {
    slug: 'longevity',
    nameJa: '長寿・細胞老化',
    ...
    ingredientSlugs: ['quercetin', 'fisetin', 'spermidine', 'nicotinamide-riboside', 'alpha-ketoglutarate', 'nmn', 'resveratrol'],
  },
  {
    slug: 'eye-health',
    nameJa: '目の老化・眼の健康',
