...
export const CANONICAL_INTERACTIONS: CanonicalEntry[] = [
  ...
  // ============================================================
  // 追加 canonical（OTC + 一般処方薬を網羅・ブランド名検索対応）
  // ============================================================

  // 呼吸器
  { key: '去痰薬', category: 'other_drug', pattern: /去痰|カルボシステイン|ムコダイン|アンブロキソール|ムコソルバン|ブロムヘキシン|ビソルボン|L-?カルボシステイン/ },
  { key: '鎮咳薬', category: 'other_drug', pattern: /鎮咳|デキストロメトルファン|メジコン|チペピジン|アスベリン|ジヒドロコデイン/ },
  { key: '吸入ステロイド', category: 'other_drug', pattern: /吸入ステロイド|フルチカゾン|ブデソニド|ベクロメタゾン|シクレソニド|モメタゾン|アドエア|レルベア|シムビコート|フルティフォーム|キュバール|アズマネックス|パルミコート/ },
  { key: '気管支拡張薬', category: 'other_drug', pattern: /\bLABA\b|\bLAMA\b|気管支拡張|サルメテロール|ホルモテロール|チオトロピウム|サルブタモール|アクリジニウム|スピリーバ|オンブレス|シーブリ|テオフィリン|プロカテロール/ },
  { key: 'ロイコトリエン拮抗薬', category: 'other_drug', pattern: /ロイコトリエン|モンテルカスト|プランルカスト|シングレア|キプレス|オノン/ },
  { key: '喘息生物学的製剤', category: 'other_drug', pattern: /オマリズマブ|デュピルマブ|メポリズマブ|レスリズマブ|ベンラリズマブ|テゼペルマブ|デュピクセント|ヌーカラ|ファセンラ|ゾレア|テゼスパイア/ },

  // 抗ヒスタミン（第二世代をブランド名込みで明示）
  { key: '第二世代抗ヒスタミン薬', category: 'anticholinergic', pattern: /第二世代抗ヒスタミン|フェキソフェナジン|セチリジン|レボセチリジン|ロラタジン|デスロラタジン|ビラスチン|エピナスチン|エバスチン|オロパタジン|ベポタスチン|ルパタジン|アレグラ|ジルテック|ザイザル|クラリチン|ビラノア|デザレックス|アレロック|タリオン|ザジテン/ },

  // 消化器
  { key: '整腸薬', category: 'other_drug', pattern: /整腸|ビオフェルミン|ミヤBM|ラックビー|乳酸菌製剤|酪酸菌製剤|耐性乳酸菌|ビオスリー/ },
  { key: '下痢止め', category: 'other_drug', pattern: /下痢止め|止瀉|ロペラミド|タンナルビン|ロペミン/ },
  { key: '便秘薬', category: 'other_drug', pattern: /便秘.*薬|緩下|酸化マグネシウム|マグミット|ピコスルファート|リンゼス|グーフィス|リナクロチド|エロビキシバット|モビコール|ラキソベロン/ },
  { key: '胃粘膜保護薬', category: 'gastric', pattern: /胃粘膜保護|レバミピド|テプレノン|ムコスタ|セルベックス|プロマック/ },
  { key: '制酸剤', category: 'gastric', pattern: /制酸剤|アルロイドG|炭酸水素ナトリウム|水酸化アルミニウム|マーロックス/ },
  { key: '消化管運動改善薬', category: 'other_drug', pattern: /消化管運動|モサプリド|イトプリド|メトクロプラミド|ガスモチン|ガナトン|プリンペラン/ },

  // 漢方
  { key: '漢方薬', category: 'other_drug', pattern: /漢方|葛根湯|抑肝散|加味逍遥散|桂枝茯苓丸|当帰芍薬散|大建中湯|防風通聖散|麦門冬湯|補中益気湯|六君子湯|小柴胡湯|半夏厚朴湯|柴苓湯|芍薬甘草湯|加味帰脾湯/ },

  // 鎮痛・神経
  { key: 'トリプタン製剤', category: 'other_drug', pattern: /トリプタン|スマトリプタン|ゾルミトリプタン|エレトリプタン|リザトリプタン|ナラトリプタン|イミグラン|ゾーミッグ|レルパックス|マクサルト|アマージ/ },
  { key: 'プレガバリン・ガバペンチン', category: 'antiepileptic', pattern: /プレガバリン|ガバペンチン|ミロガバリン|リリカ|タリージェ|ガバペン/ },

  // 抗感染症
  { key: 'セフェム系抗生物質', category: 'antibiotic', pattern: /セフェム|セファロスポリン|セファレキシン|セフジニル|セフポドキシム|セフカペン|セフトリアキソン|セフタジジム|セフメタゾール|フロモックス|メイアクト|セフゾン|ケフラール|バナン|サワシリン|ロセフィン/ },
  { key: '抗ヘルペス薬', category: 'antibiotic', pattern: /抗ヘルペス|アシクロビル|バラシクロビル|ファムシクロビル|アメナメビル|ゾビラックス|バルトレックス|アメナリーフ|ファムビル/ },
  { key: '抗インフルエンザ薬', category: 'antibiotic', pattern: /抗インフル|オセルタミビル|ザナミビル|バロキサビル|ペラミビル|タミフル|リレンザ|ゾフルーザ|ラピアクタ|イナビル/ },
  { key: '抗真菌外用薬', category: 'topical', pattern: /抗真菌外用|テルビナフィン|ラミシール|ルリコナゾール|ルコナック|ルリコン|ケトコナゾール外用|クロトリマゾール/ },

  // 睡眠
  { key: 'オレキシン受容体拮抗薬', category: 'sedative', pattern: /オレキシン受容体|スボレキサント|レンボレキサント|ベルソムラ|デエビゴ/ },
  { key: 'メラトニン受容体作動薬', category: 'sedative', pattern: /メラトニン受容体|ラメルテオン|ロゼレム/ },

  // 泌尿器
  { key: '過活動膀胱治療薬', category: 'anticholinergic', pattern: /過活動膀胱|ソリフェナシン|ミラベグロン|イミダフェナシン|プロピベリン|フェソテロジン|ベシケア|ベタニス|ウリトス|ステーブラ|トビエース|バップフォー|デトルシトール/ },

  // リウマチ・自己免疫
  { key: 'JAK阻害薬', category: 'immunosuppressant', pattern: /JAK阻害|バリシチニブ|トファシチニブ|ウパダシチニブ|フィルゴチニブ|ペフィシチニブ|オルミエント|ゼルヤンツ|リンヴォック|スマイラフ/ },
  { key: 'TNF阻害薬', category: 'immunosuppressant', pattern: /TNF阻害|インフリキシマブ|アダリムマブ|エタネルセプト|ゴリムマブ|セルトリズマブ|レミケード|ヒュミラ|エンブレル|シンポニー|シムジア/ },
  { key: 'IL-6阻害薬', category: 'immunosuppressant', pattern: /IL-?6阻害|トシリズマブ|サリルマブ|アクテムラ|ケブザラ/ },
  { key: 'PDE-4阻害薬', category: 'immunosuppressant', pattern: /PDE.?4|アプレミラスト|オテズラ/ },

  // ホルモン療法（既存補完）
  { key: 'GnRH作動薬', category: 'hormone', pattern: /GnRH|リュープロレリン|ゴセレリン|リュープリン|ゾラデックス|スプレキュア/ },
  { key: '糖質コルチコイド経口', category: 'immunosuppressant', pattern: /糖質コルチコイド経口|経口ステロイド|プレドニン|メドロール|デカドロン経口/ },

  // 抗うつ補助
  { key: 'NaSSA・トラゾドン', category: 'antidepressant', pattern: /NaSSA|ミルタザピン|トラゾドン|リフレックス|レメロン|レスリン|デジレル/ },

  // 緑内障・眼科
  { key: 'プロスタグランジン点眼', category: 'other_drug', pattern: /ラタノプロスト|トラボプロスト|タフルプロスト|ビマトプロスト|キサラタン|トラバタンズ|タプロス|ルミガン/ },
  { key: '緑内障点眼薬', category: 'other_drug', pattern: /緑内障|チモロール|カルテオロール|ピロカルピン|ブリモニジン|ドルゾラミド|チモプトール|エイベリス/ },

  // 禁煙
  { key: '禁煙補助薬', category: 'other_drug', pattern: /禁煙|バレニクリン|ニコチン製剤|チャンピックス|ニコチネル|ニコレット/ },

  // OTC 風邪薬
  { key: '総合感冒薬', category: 'other_drug', pattern: /総合感冒|風邪薬|PL顆粒|パブロン|ルル|コルゲン|ベンザ|エスタック/ },
]
